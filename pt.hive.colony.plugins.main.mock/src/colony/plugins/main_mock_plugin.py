...
class MainMockPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_mock/mock/resources/baf.xml"}
    capabilities = ["startup", "mock", "build_automation_item"]
