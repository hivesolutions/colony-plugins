...
class MainDistributionServicePlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    @colony.plugins.decorators.load_plugin("pt.hive.colony.plugins.distribution.main.registry.service", "1.0.0")
