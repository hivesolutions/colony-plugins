...
class PackagingDebPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    capabilities = ["packaging.deb", "build_automation_item"]
    ...
    @colony.plugins.decorators.plugin_inject("pt.hive.colony.plugins.packaging.ar")
