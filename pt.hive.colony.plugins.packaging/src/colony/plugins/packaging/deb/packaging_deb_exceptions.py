...
class PackagingDebException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
    The packaging deb exception class.
    """

    message = None
    """ The exception's message """

class MissingParameter(PackagingDebException):
    """
...
class FileNotFound(PackagingDebException):
    """
