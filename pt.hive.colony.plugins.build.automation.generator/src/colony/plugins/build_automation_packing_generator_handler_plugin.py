...
class BuildAutomationPackingGeneratorHandlerPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["build_automation_generator.packing_generator_handler.build_automation_packing_generator_handler_system"]
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.build.automation.packing_generator_handler", "1.0.0")
