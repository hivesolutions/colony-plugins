...
class BuildAutomationGeratorPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    @colony.plugins.decorators.load_allowed("pt.hive.colony.plugins.build.automation.generator", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.plugins.decorators.unload_allowed("pt.hive.colony.plugins.build.automation.generator", "1.0.0")
    ...
    @colony.plugins.decorators.load_allowed_capability("build_automation_generator_handler")
    ...
    @colony.plugins.decorators.unload_allowed_capability("build_automation_generator_handler")
