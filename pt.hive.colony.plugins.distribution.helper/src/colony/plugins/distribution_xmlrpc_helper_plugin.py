...
class DistributionXmlrpcHelperPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    capabilities = ["distribution_helper"]
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.distribution.helper.xmlrpc", "1.0.0")
    ...
    @colony.plugins.decorators.plugin_inject("pt.hive.colony.plugins.main.remote.client.xmlrpc")
