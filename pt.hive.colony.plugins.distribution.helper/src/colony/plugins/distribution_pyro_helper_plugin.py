...
class DistributionPyroHelperPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.distribution.helper.pyro", "1.0.0")
    ...
    @colony.base.decorators.plugin_inject("pt.hive.colony.plugins.main.remote.client.pyro")
