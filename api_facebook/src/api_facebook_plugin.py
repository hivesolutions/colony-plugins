...
class ApiFacebookPlugin(colony.base.system.Plugin):
    """
    ...
    def load_plugin(self):
        ...
        import api_facebook.system
        self.api_facebook = api_facebook.system.ApiFacebook(self)
    ...
    def create_remote_client(self, api_attributes):
        ...
        return self.api_facebook.create_remote_client(api_attributes)
