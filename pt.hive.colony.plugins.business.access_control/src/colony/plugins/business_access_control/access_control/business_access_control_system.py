...
class BusinessAccessControl:
    """
    The business access control class.
    """

    business_access_control_plugin = None
    """ The business access control plugin """
    ...
    def __init__(self, business_access_control_plugin):
        ...
        self.business_access_control_plugin = business_access_control_plugin
