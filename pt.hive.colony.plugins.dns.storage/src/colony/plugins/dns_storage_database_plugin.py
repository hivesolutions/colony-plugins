...
class DnsStorageDatabasePlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/dns_storage_database/database/resources/baf.xml"
    }
    capabilities = [
        "dns_storage",
    ...
    main_modules = [
        "dns_storage_database.database.dns_storage_database_entities",
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.dns.storage.database", "1.0.0")
