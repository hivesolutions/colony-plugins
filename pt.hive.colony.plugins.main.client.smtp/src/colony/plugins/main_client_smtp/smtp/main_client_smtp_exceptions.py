...
class MainClientSmtpException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
...
class ClientResponseTimeout(MainClientSmtpException):
    """
...
class ServerResponseTimeout(MainClientSmtpException):
    """
...
class ResponseClosed(MainClientSmtpException):
    """
