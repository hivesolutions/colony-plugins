...
class MainRestEncoderJsonPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["main_remote_rest_encoder.json.main_rest_encoder_json_system"]
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.remote.rest.encoder.json", "1.0.0")
