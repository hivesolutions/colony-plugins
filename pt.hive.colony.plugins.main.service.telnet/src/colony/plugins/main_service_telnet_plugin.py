...
class MainServiceTelnetPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.telnet", "1.0.0")
