...
class MainServiceTelnetPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Telnet Service Main plugin.
    """

    id = "pt.hive.colony.plugins.main.service.telnet"
    name = "Telnet Service Main Plugin"
    short_name = "Telnet Service Main"
    description = "The plugin that offers the telnet service"
    version = "1.0.0"
    ...
    def load_plugin(self):
        ...
        global main_service_telnet
        import main_service_telnet.telnet.main_service_telnet_system
        self.main_service_telnet = main_service_telnet.telnet.main_service_telnet_system.MainServiceTelnet(self)
    ...
    @colony.base.decorators.load_allowed("pt.hive.colony.plugins.main.service.telnet", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.base.decorators.unload_allowed("pt.hive.colony.plugins.main.service.telnet", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.telnet", "1.0.0")
    def dependency_injected(self, plugin):
        colony.base.plugin_system.Plugin.dependency_injected(self, plugin)

    @colony.base.decorators.set_configuration_property("pt.hive.colony.plugins.main.service.telnet", "1.0.0")
    def set_configuration_property(self, property_name, property):
        colony.base.plugin_system.Plugin.set_configuration_property(self, property_name, property)

    @colony.base.decorators.unset_configuration_property("pt.hive.colony.plugins.main.service.telnet", "1.0.0")
    ...
    @colony.base.decorators.unload_allowed_capability("telnet_service_handler")
    ...
    def service_configuration_set_configuration_property(self, property_name, property):
        self.main_service_telnet.set_service_configuration_property(property)
    ...
    def service_configuration_unset_configuration_property(self, property_name):
        self.main_service_telnet.unset_service_configuration_property()
