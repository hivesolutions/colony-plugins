...
class ${out value=scaffold_attributes.model.class_name /}Controller:
    ...
    def _get_${out value=scaffold_attributes.model.variable_name_plural /}(self, rest_request, filter):
        ...
        ${out value=scaffold_attributes.model.variable_name /}_entities = ${out value=scaffold_attributes.variable_name /}_entity_models.${out value=scaffold_attributes.model.class_name /}.find(filter)
    ...
    def _get_${out value=scaffold_attributes.model.variable_name /}(self, rest_request, ${out value=scaffold_attributes.model.variable_name /}_object_id):
        ...
        ${out value=scaffold_attributes.model.variable_name /}_entity = ${out value=scaffold_attributes.variable_name /}_entity_models.${out value=scaffold_attributes.model.class_name /}.get(${out value=scaffold_attributes.model.variable_name /}_object_id)
