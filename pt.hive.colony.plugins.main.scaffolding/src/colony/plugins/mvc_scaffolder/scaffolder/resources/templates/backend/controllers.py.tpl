...
class ${out value=scaffold_attributes.model.class_name /}Controller:
    ...
    def _get_${out value=scaffold_attributes.model.variable_name /}(self, rest_request, ${out value=scaffold_attributes.model.variable_name /}_object_id):
        ...
        ${out value=scaffold_attributes.model.variable_name /}_entity = ${out value=scaffold_attributes.variable_name /}_entity_models.entity_manager.get(${out value=scaffold_attributes.variable_name /}_entity_models.${out value=scaffold_attributes.model.class_name /}, ${out value=scaffold_attributes.model.variable_name /}_object_id)
