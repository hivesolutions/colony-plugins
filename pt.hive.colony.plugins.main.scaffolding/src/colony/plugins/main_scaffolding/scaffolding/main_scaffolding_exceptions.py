...
class MainScaffoldingException(colony.base.plugin_system_exceptions.ColonyException):
    """
    The main scaffolding exception.
    """

    message = None
    """ The exception's message """

class ScaffolderTypeNotSupported(MainScaffoldingException):
    """
    The scaffolder type not supported class.
    """
