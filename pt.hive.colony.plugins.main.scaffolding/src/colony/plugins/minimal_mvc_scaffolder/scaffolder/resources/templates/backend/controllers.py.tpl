...
class ${out value=scaffold_attributes.model.class_name /}Controller:
    ...
    def handle_list(self, rest_request, parameters = {}):
        ${out value=scaffold_attributes.model.variable_name /}_entities = self.entity_models.${out value=scaffold_attributes.model.class_name /}.find()
    ...
    def handle_show(self, rest_request, parameters = {}):
        ...
        ${out value=scaffold_attributes.model.variable_name /}_entity = self.entity_models.${out value=scaffold_attributes.model.class_name /}.get(${out value=scaffold_attributes.model.variable_name /}_object_id)
