...
class FileManagerZipEnginePlugin(colony.base.system.Plugin):
    ...
    main_modules = [
        "data.file_manager_zip_engine.system"
    ]
    ...
    def load_plugin(self):
        ...
        import data.file_manager_zip_engine.system
        self.file_manager_zip_engine = data.file_manager_zip_engine.system.FileManagerZipEngine(self)
