...
class BusinessDummyEntityBundlePlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/business_dummy/dummy_entity_bundle/resources/baf.xml",
    ...
    main_modules = [
        "business_dummy.dummy_entity_bundle.business_dummy_entity_bundle_classes",
        "business_dummy.dummy_entity_bundle.business_dummy_entity_bundle_system"
    ]

    business_dummy_entity_bundle = None
    """ The business dummy entity bundle """
