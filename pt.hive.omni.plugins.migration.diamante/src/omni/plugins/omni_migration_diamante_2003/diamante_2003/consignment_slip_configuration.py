...
class ConsignmentSlipConfiguration:
    """
    Provides the migration configuration necessary to migrate
    omni ConsignmentSlip entities from diamante.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract consignment slip entities from compras entities
        ...
        # defines how to extract consignment slip entities from vendas entities
        ...
        self.attribute_mapping_output_entities = [{NAME_VALUE : "ConsignmentSlip",
