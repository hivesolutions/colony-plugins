...
class CollectionConfiguration:
    ...
    omni Collection entities from diamante.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract collection entities from coleccao entities
        coleccao_input_entities = {NAME_VALUE : "coleccao",
        ...
        self.attribute_mapping_output_entities = [{NAME_VALUE : "Collection",
                                                   INPUT_ENTITIES_VALUE : [coleccao_input_entities]}]
