...
DIAMANTE_CASH_PAYMENT_TYPE = "DIN"
""" The cash payment type indicator in diamante """

class CashPaymentConfiguration:
    """
    Provides the migration configuration necessary to migrate
    omni CashPayment entities from diamante.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract cash payment entities from fpvendas entities
        fpvendas_input_entities = {NAME_VALUE : "fpvendas",
                                   OUTPUT_ENTITIES_VALUE : [{VALIDATORS_VALUE : [{FUNCTION_VALUE : "entity_validator_has_all_attribute_values",
                                                                                  ...
                                                                                  ARGUMENTS_VALUE : {ATTRIBUTES_VALUE : {"FORMA" : DIAMANTE_CASH_PAYMENT_TYPE}}}],
                                                             OUTPUT_ATTRIBUTES_VALUE : []}]}

        # defines how to extract cash payment entities
        self.attribute_mapping_output_entities = [{NAME_VALUE : "CashPayment",
