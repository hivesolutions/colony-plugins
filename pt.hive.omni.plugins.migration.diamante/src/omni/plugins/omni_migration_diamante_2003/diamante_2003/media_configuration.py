...
USER_HOME_RESOURCE_ID = "system.path.user_home"
""" The unique identifier for the user home path in the resource manager """

DIAMANTE_IMAGES_PATH = "DIA2002/IMAGENS/DEFINITIVO"
""" The path to the images in diamante """

IMAGE_FILE_REGEX = ".*(/|\\\\)([a-zA-Z]|[0-9])+.*\.(jpg|JPG|jpeg|JPEG)"
""" Regular expression used to match image files """
...
class MediaConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        user_home_path_resource = resource_manager_plugin.get_resource(USER_HOME_RESOURCE_ID)
        user_home_path = user_home_path_resource.data
        diamante_images_path = os.path.join(user_home_path, DIAMANTE_IMAGES_PATH)
        ...
        self.input_io_adapters_options = [{IO_ADAPTER_PLUGIN_ID_VALUE : IO_ADAPTER_FILESYSTEM_PLUGIN_ID,
                                           DIRECTORY_PATHS_VALUE : [diamante_images_path],
                                           ENTITY_NAME_PATH_REGEX_MAP_VALUE : {"imagens_definitivo" : IMAGE_FILE_REGEX}}]

        # defines how to extract media entities from imagens definitivo entities
        imagens_input_entities = {NAME_VALUE : "imagens_definitivo",
        ...
        self.attribute_mapping_output_entities = [{NAME_VALUE : "Media",
                                                   INPUT_ENTITIES_VALUE : [imagens_input_entities]}]
