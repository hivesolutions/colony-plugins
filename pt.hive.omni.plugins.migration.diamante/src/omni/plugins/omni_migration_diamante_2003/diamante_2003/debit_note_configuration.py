...
DIAMANTE_DEBIT_NOTE_DOCUMENT_TYPE = "NDB"
""" The debit note document type indicator in diamante """

OMNI_DOCUMENT_COMPLETED_STATUS = 2
""" The completed document status indicator in omni """

class DebitNoteConfiguration:
    """
    Provides the migration configuration necessary to migrate
    omni DebitNote entities from diamante.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract debit note entities from vendas entities
        vendas_input_entities = {NAME_VALUE : "vendas",
                                 OUTPUT_ENTITIES_VALUE : [{VALIDATORS_VALUE : [{FUNCTION_VALUE : "entity_validator_has_all_attribute_values",
                                                                                ...
                                                                                ARGUMENTS_VALUE : {ATTRIBUTES_VALUE : {"TIPODOC" : DIAMANTE_DEBIT_NOTE_DOCUMENT_TYPE}}}],
        ...
        # defines how to extract debit note entities
        self.attribute_mapping_output_entities = [{NAME_VALUE : "DebitNote",
