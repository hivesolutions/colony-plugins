...
DIAMANTE_POST_DATED_CHECK_PAYMENT = "CHP"
""" Post-dated check payment indicator in diamante """

class PostDatedCheckPaymentConfiguration:
    """
    Provides the migration configuration necessary to migrate
    omni PostDatedCheckPayment entities from diamante.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract post dated check payment entities from fpvendas entities
        fpvendas_input_entities = {NAME_VALUE : "fpvendas",
                                   OUTPUT_ENTITIES_VALUE : [{VALIDATORS_VALUE : [{FUNCTION_VALUE : "entity_validator_has_all_attribute_values",
                                                                                  ...
                                                                                  ARGUMENTS_VALUE : {ATTRIBUTES_VALUE : {"FORMA" : DIAMANTE_POST_DATED_CHECK_PAYMENT}}}],
        ...
        # defines how to extract post dated check payment entities
        self.attribute_mapping_output_entities = [{NAME_VALUE : "PostDatedCheckPayment",
