...
class InvalidPaymentConfiguration:
    """
    Provides the migration configuration necessary to migrate
    omni InvalidPayment entities from diamante.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract invalid payment entities from fpvendas entities
        ...
        # defines how to extract invalid payment entities
        self.attribute_mapping_output_entities = [{NAME_VALUE : "InvalidPayment",
