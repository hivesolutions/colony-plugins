...
class UserConfiguration:
    ...
    omni User entities from diamante.
    """

    omni_migration_diamante_2003_lugar_da_joia_plugin = None
    """ The omni migration diamante 2003 lugar da joia plugin """
    ...
    def post_attribute_mapping_handler_create_users(self, data_converter, input_intermediate_structure, output_intermediate_structure, arguments):
        self.omni_migration_diamante_2003_lugar_da_joia_plugin.info("Creating default users")

        user_entity = output_intermediate_structure.create_entity("User")
        user_entity.set_attribute("username", "ldj")
        user_entity.set_attribute("password_hash", "123123123")
