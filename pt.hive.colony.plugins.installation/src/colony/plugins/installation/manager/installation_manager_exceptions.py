...
class InstallationBaseException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
...
class MissingParameter(InstallationBaseException):
    """
    ...
    def __init__(self, message):
        ...
        InstallationBaseException.__init__(self)
