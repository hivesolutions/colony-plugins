...
class InstallationZipException(colony.base.plugin_system_exceptions.ColonyException):
    """
    The installation zip exception class.
    """

    message = None
    """ The exception's message """

class MissingParameter(InstallationZipException):
    """
    ...
    def __init__(self, message):
        ...
        InstallationZipException.__init__(self)
