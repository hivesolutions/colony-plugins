...
class ValidationBundlePlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/validation_bundle/bundle/resources/baf.xml"}
    capabilities = ["validation.bundle", "console_command_extension", "build_automation_item"]
    capabilities_allowed = []
    dependencies = [colony.base.plugin_system.PluginDependency(
                    "pt.hive.colony.plugins.misc.json", "1.0.0")]
    events_handled = []
    events_registrable = []
    main_modules = ["validation_bundle.bundle.console_validation_bundle",
    ...
    @colony.base.decorators.load_allowed("pt.hive.colony.plugins.validation.bundle", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.base.decorators.unload_allowed("pt.hive.colony.plugins.validation.bundle", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.validation.bundle", "1.0.0")
    ...
    def get_all_commands(self):
        return self.console_validation_bundle.get_all_commands()

    def get_handler_command(self, command):
        return self.console_validation_bundle.get_handler_command(command)

    def get_help(self):
        return self.console_validation_bundle.get_help()
