...
class UsersDocxPlugin(colony.plugins.plugin_system.Plugin):

    id = "pt.hive.colony.plugins.hivefs.users_docx"
    name = "Hive Filesystem Users DOCX plugin"
    short_name = "HiveFS Users DOCX plugin"
    description = "Hive file system Users DOCX plugin"
    version = "1.0.0"
    ...
    def load_plugin(self):
        ...
        global hivefs
        import hivefs.users.users_docx_system
    ...
    def end_load_plugin(self):
        ...
        self.codebase = hivefs.users.users_docx_system.HiveFSUsersDocx(self)
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.hivefs.users_docx", "1.0.0")
