...
class Visitor:
    ...
    @_visit(printing_language_ast.AstNode)
    def visit_ast_node(self, node):
        print "AstNode: " + str(node)

    @_visit(printing_language_ast.GenericElement)
    def visit_generic_element(self, node):
        print "GenericElement: " + str(node)

    @_visit(printing_language_ast.PrintingDocument)
    def visit_printing_document(self, node):
        print "PrintingDocument: " + str(node)

    @_visit(printing_language_ast.Paragraph)
    def visit_paragraph(self, node):
        print "Paragraph: " + str(node)

    @_visit(printing_language_ast.Line)
    def visit_line(self, node):
        print "Line: " + str(node)

    @_visit(printing_language_ast.Text)
    def visit_text(self, node):
        print "Text: " + str(node)

    @_visit(printing_language_ast.Image)
