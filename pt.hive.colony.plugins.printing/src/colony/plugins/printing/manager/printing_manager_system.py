...
import printing_manager_exceptions
...
class PrintingManager:
    ...
    def _get_printing_plugin(self, printing_options):
        ...
        if printing_name:
            ...
            if self.printing_manager_plugin.printing_plugins:
                # retrieves the first printing plugin
                printing_plugin = self.printing_manager_plugin.printing_plugins[0]
            else:
        ...
        if not printing_plugin:
            ...
            raise printing_manager_exceptions.PrintingPluginNotAvailable("the required printer is not available or no printers are available")
