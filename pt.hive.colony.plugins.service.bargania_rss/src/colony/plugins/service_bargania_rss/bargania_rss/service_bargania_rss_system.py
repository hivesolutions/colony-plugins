...
class BarganiaRssClient:
    ...
    def get_bargania_items(self):
        ...
        for item_node in item_nodes:
            ...
            bargania_deal_location_id = self.get_xml_node_text(bargania_deal_node, "bargania:location_id")
            bargania_deal_title = self.get_xml_node_text(bargania_deal_node, "bargania:title")
            bargania_deal_description = self.get_xml_node_text(bargania_deal_node, "bargania:description")
            bargania_deal_details_url = self.get_xml_node_text(bargania_deal_node, "bargania:details_url")
            bargania_deal_purchase_url = self.get_xml_node_text(bargania_deal_node, "bargania:purchase_url")
            bargania_deal_currency = self.get_xml_node_text(bargania_deal_node, "bargania:currency")
            bargania_deal_retail_price = self.get_xml_node_text(bargania_deal_node, "bargania:retail_price")
            bargania_deal_discounted_price = self.get_xml_node_text(bargania_deal_node, "bargania:discounted_price")
            bargania_deal_number_purchases = self.get_xml_node_text(bargania_deal_node, "bargania:number_purchases", DEFAULT_NUMBER_PURCHASES)
            bargania_deal_minimum_purchases = self.get_xml_node_text(bargania_deal_node, "bargania:minimum_purchases", DEFAULT_MINIMUM_PURCHASES)
            bargania_deal_maximum_purchases = self.get_xml_node_text(bargania_deal_node, "bargania:maximum_purchases", DEFAULT_MAXIMUM_PURCHASES)
            bargania_deal_expiration_date = self.get_xml_node_text(bargania_deal_node, "bargania:expiration_date")

            # retrieves the bargania deal relations
            bargania_deal_advertisement_media = self._get_media(bargania_deal_node, "bargania:advertisement_media")
            bargania_deal_category = self._get_category(bargania_deal_node, "bargania:category")
            bargania_deal_store = self._get_store(bargania_deal_node, "bargania:store")
            bargania_deal_primary_address = self._get_address(bargania_deal_node, "bargania:primary_address")
            bargania_deal_primary_contact_information = self._get_contact_information(bargania_deal_node, "bargania:primary_contact_information")
