...
class ServiceBarganiaRssPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Bargania Rss Service plugin.
    """

    id = "pt.hive.colony.plugins.service.bargania_rss"
    name = "Bargania Rss Service Plugin"
    short_name = "Bargania Rss Service Main"
    description = "The plugin that offers the bargania rss service"
    version = "1.0.0"
    author = "Hive Solutions Lda. <development@hive.pt>"
    loading_type = colony.base.plugin_system.EAGER_LOADING_TYPE
    platforms = [colony.base.plugin_system.CPYTHON_ENVIRONMENT]
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/service_bargania_rss/bargania_rss/resources/baf.xml"}
    capabilities = ["service.bargania_rss", "build_automation_item"]
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.service.bargania_rss", "1.0.0")
    ...
    def create_remote_client(self, service_attributes):
        ...
        @rtype: BarganiaRssClient
        @return: The created remote client.
        """

        return self.service_bargania_rss.create_remote_client(service_attributes)
