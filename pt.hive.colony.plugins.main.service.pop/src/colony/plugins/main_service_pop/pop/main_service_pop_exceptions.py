...
class MainServicePopException(colony.base.plugin_system_exceptions.ColonyException):
    """
...
class PopDataRetrievalException(PopRuntimeException):
    """
    The pop data retrieval exception.
    """
    ...
    def __str__(self):
        ...
        return "Pop data retrieval exception: %s" % self.message

class PopDataSendingException(PopRuntimeException):
    """
    The pop data sending exception.
    """
    ...
    def __str__(self):
        ...
        return "Pop data sending exception: %s" % self.message
