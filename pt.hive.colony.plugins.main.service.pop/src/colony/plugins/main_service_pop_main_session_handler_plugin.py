...
class MainServicePopMainSessionHandlerPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/main_service_pop_main_session_handler/main_session_handler/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "main_service_pop_main_session_handler.main_session_handler.main_service_pop_main_session_handler_exceptions",
    ...
    """ The main service pop main session handler """

    pop_service_message_provider_plugins = []
    """ The pop service message provider plugins """
