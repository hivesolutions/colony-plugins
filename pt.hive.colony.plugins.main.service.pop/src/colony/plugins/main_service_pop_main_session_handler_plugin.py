...
class MainServicePopMainSessionHandlerPlugin(colony.plugins.plugin_system.Plugin):
    ...
    def handle_session(self, session):
        ...
        self.main_service_pop_main_session_handler.handle_session(session)
    ...
    def pop_service_message_provider_load_allowed(self, plugin, capability):
        ...
        self.main_service_pop_main_session_provider.pop_service_message_provider_load(plugin)
    ...
    def pop_service_message_provider_unload_allowed(self, plugin, capability):
        ...
        self.main_service_pop_main_session_provider.pop_service_message_provider_unload(plugin)
