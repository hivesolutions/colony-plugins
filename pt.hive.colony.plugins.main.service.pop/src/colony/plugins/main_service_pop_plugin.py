...
class MainServicePopPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.load_allowed("pt.hive.colony.plugins.main.service.pop", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.base.decorators.unload_allowed("pt.hive.colony.plugins.main.service.pop", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.pop", "1.0.0")
    def dependency_injected(self, plugin):
        colony.base.plugin_system.Plugin.dependency_injected(self, plugin)

    @colony.base.decorators.set_configuration_property("pt.hive.colony.plugins.main.service.pop", "1.0.0")
    def set_configuration_property(self, property_name, property):
        colony.base.plugin_system.Plugin.set_configuration_property(self, property_name, property)

    @colony.base.decorators.unset_configuration_property("pt.hive.colony.plugins.main.service.pop", "1.0.0")
    def unset_configuration_property(self, property_name):
        colony.base.plugin_system.Plugin.unset_configuration_property(self, property_name)

    def start_service(self, parameters):
        return self.main_service_pop.start_service(parameters)

    def stop_service(self, parameters):
        return self.main_service_pop.stop_service(parameters)

    @colony.base.decorators.load_allowed_capability("pop_service_handler")
    ...
    @colony.base.decorators.load_allowed_capability("pop_service_authentication_handler")
    ...
    @colony.base.decorators.load_allowed_capability("pop_service_session_handler")
    ...
    @colony.base.decorators.unload_allowed_capability("pop_service_handler")
    ...
    @colony.base.decorators.unload_allowed_capability("pop_service_authentication_handler")
    ...
    @colony.base.decorators.unload_allowed_capability("pop_service_session_handler")
    ...
    def set_thread_pool_manager_plugin(self, main_service_utils_plugin):
    ...
    def service_configuration_set_configuration_property(self, property_name, property):
        self.main_service_pop.set_service_configuration_property(property)
    ...
    def service_configuration_unset_configuration_property(self, property_name):
        self.main_service_pop.unset_service_configuration_property()
