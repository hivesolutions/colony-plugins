...
class ServiceDropbox:
    """
    The service dropbox class.
    """

    service_dropbox_plugin = None
    """ The service dropbox plugin """

    def __init__(self, service_dropbox_plugin):
        """
        Constructor of the class.

        @type service_dropbox_plugin: ServiceDropboxPlugin
        @param service_dropbox_plugin: The service dropbox plugin.
        """

        self.service_dropbox_plugin = service_dropbox_plugin
