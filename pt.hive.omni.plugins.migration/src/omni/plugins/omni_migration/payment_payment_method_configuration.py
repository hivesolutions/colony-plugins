...
class PaymentPaymentMethodConfiguration:
    ...
    omni PaymentPaymentMethod entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "PaymentPaymentMethod",
                                             ATTRIBUTES_VALUE : {"amount" : {TYPES_VALUE : NUMERIC_TYPE},
                                                                 "payment" : {TYPES_VALUE : ["Payment"]},
                                                                 "payment_method" : {TYPES_VALUE : ["CashPayment",
                                                                                                    "CheckPayment",
                                                                                                    "CardPayment",
                                                                                                    "CreditNotePayment",
                                                                                                    "InvalidPayment",
