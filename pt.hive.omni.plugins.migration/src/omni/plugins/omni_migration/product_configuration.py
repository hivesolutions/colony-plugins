...
class ProductConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "Product",
                                             ATTRIBUTES_VALUE : {"name" : {TYPES_VALUE : STRING_TYPE},
                                                                 "company_product_code" : {TYPES_VALUE : STRING_TYPE},
                                                                 "sellable" : {TYPES_VALUE : INTEGER_TYPE},
                                                                 "weight" : {TYPES_VALUE : NUMERIC_TYPE},
                                                                 "upc" : {TYPES_VALUE : STRING_TYPE},
                                                                 ...
                                                                 "parent_nodes" : {LIST_TYPE_VALUE : True,
                                                                                   TYPES_VALUE : ["Collection",
                                                                                                  "Category",
                                                                                                  "MerchandiseHierarchyTreeNode"]},
                                                                 "child_nodes" : {LIST_TYPE_VALUE : True,
                                                                                  TYPES_VALUE : ["SubProduct"]},
                                                                 "media" : {LIST_TYPE_VALUE : True,
                                                                            TYPES_VALUE : ["Media"]},
                                                                 "primary_media" : {TYPES_VALUE : ["Media"]},
                                                                 "return_lines" : {LIST_TYPE_VALUE : True,
                                                                                   TYPES_VALUE : ["MerchandiseHierarchyTreeNodeReturn"]},
                                                                 ...
                                                                 "transfer_lines" : {LIST_TYPE_VALUE : True,
                                                                                     TYPES_VALUE : ["TransferMerchandiseHierarchyTreeNode"]},
                                                                 "stock_adjustment_lines" : {LIST_TYPE_VALUE : True,
                                                                                             TYPES_VALUE : ["StockAdjustmentMerchandiseHierarchyTreeNode"]},
                                                                 "consignments" : {LIST_TYPE_VALUE : True,
                                                                                   TYPES_VALUE : ["ConsignmentMerchandiseHierarchyTreeNode"]},
