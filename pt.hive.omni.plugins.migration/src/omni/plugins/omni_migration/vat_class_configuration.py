...
class VatClassConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "VatClass",
                                             ATTRIBUTES_VALUE : {"name" : {TYPES_VALUE : STRING_TYPE},
                                                                 "start_date" : {TYPES_VALUE : DATE_TYPE},
                                                                 "end_date" : {TYPES_VALUE : DATE_TYPE},
                                                                 "vat_rate" : {TYPES_VALUE : FLOAT_TYPE},
