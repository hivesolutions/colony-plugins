...
class PersonRelationConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "PersonRelation",
                                             ATTRIBUTES_VALUE : {"type" : {TYPES_VALUE : INTEGER_TYPE},
                                                                 "first_person" : {TYPES_VALUE : ["CustomerPerson"]},
                                                                 "second_person" : {TYPES_VALUE : ["CustomerPerson"]},
