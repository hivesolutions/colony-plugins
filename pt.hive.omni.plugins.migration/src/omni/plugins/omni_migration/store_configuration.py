...
class StoreConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "Store",
                                             ATTRIBUTES_VALUE : {"name" : {TYPES_VALUE : STRING_TYPE},
                                                                 "observations" : {TYPES_VALUE : STRING_TYPE},
                                                                 "sales_stockholder" : {LIST_TYPE_VALUE : True,
                                                                 ...
                                                                 "parent_nodes" : {LIST_TYPE_VALUE : True,
                                                                                   TYPES_VALUE : ["SystemCompany",
                                                                                                  "Company",
                                                                                                  "Department"]},
                                                                 "child_nodes" : {LIST_TYPE_VALUE : True,
                                                                                   TYPES_VALUE : ["Employee"]},
                                                                 "sent_transfers" : {LIST_TYPE_VALUE : True,
                                                                                     TYPES_VALUE : ["Transfer"]},
                                                                 "received_transfers" : {LIST_TYPE_VALUE : True,
                                                                                         TYPES_VALUE : ["Transfer"]},
                                                                 "stock_adjustments" : {LIST_TYPE_VALUE : True,
