...
class ContactInformationConfiguration:
    ...
    omni ContactInformation entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "ContactInformation",
                                             ATTRIBUTES_VALUE : {"phone_number" : {TYPES_VALUE : STRING_TYPE},
                                                                 "mobile_phone_number" : {TYPES_VALUE : STRING_TYPE},
                                                                 "fax_number" : {TYPES_VALUE : STRING_TYPE},
                                                                 "email" : {TYPES_VALUE : STRING_TYPE},
                                                                 "web_page" : {TYPES_VALUE : STRING_TYPE},
                                                                 "contactable_organizational_hierarchy_tree_node" : {TYPES_VALUE : ["CustomerPerson",
                                                                                                                                    ...
                                                                                                                                    "SupplierCompany",
                                                                                                                                    "Warehouse"]},
                                                                 "primary_contact_information_contactable_organizational_hierarchy_tree_nodes" : {LIST_TYPE_VALUE : True,
