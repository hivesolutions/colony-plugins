...
class PurchaseTransactionConfiguration:
    ...
    omni PurchaseTransaction entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "PurchaseTransaction",
                                             ATTRIBUTES_VALUE : {"date" : {TYPES_VALUE : DATE_TYPE},
                                                                 ...
                                                                 "cost" : {TYPES_VALUE : [types.IntType, types.FloatType, "Cost"]},
                                                                 ...
                                                                 "billing_site" : {TYPES_VALUE : ["Store", "SystemCompany"]},
                                                                 "delivery_site" : {TYPES_VALUE : ["Store", "SystemCompany"]},
