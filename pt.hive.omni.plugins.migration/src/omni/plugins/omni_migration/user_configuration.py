...
class UserConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "User",
                                             ATTRIBUTES_VALUE : {"username" : {TYPES_VALUE : STRING_TYPE},
                                                                 "password" : {TYPES_VALUE : STRING_TYPE},
                                                                 "password_hash" : {TYPES_VALUE : STRING_TYPE},
                                                                 "password_hash_type" : {TYPES_VALUE : STRING_TYPE},
