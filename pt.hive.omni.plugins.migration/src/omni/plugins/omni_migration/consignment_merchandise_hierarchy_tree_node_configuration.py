...
class ConsignmentMerchandiseHierarchyTreeNodeConfiguration:
    ...
    omni ConsignmentMerchandiseHierarchyTreeNode entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "ConsignmentMerchandiseHierarchyTreeNode",
                                             ATTRIBUTES_VALUE : {"consigned_quantity" : {TYPES_VALUE : INTEGER_TYPE},
