...
class CreditNotePaymentConfiguration:
    ...
    omni CreditNotePayment entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "CreditNotePayment",
                                             ATTRIBUTES_VALUE : {"credit_notes" : {LIST_TYPE_VALUE : True,
                                                                                   TYPES_VALUE : ["CreditNote"]},
