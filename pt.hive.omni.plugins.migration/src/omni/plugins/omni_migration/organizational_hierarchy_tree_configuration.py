...
class OrganizationalHierarchyTreeConfiguration:
    """
    Provides the migration configuration necessary to migrate
    omni OrganizationalHierarchyTree entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "OrganizationalHierarchyTree",
