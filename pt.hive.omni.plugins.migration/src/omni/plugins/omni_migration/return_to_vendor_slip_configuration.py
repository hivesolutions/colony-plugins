...
class ReturnToVendorSlipConfiguration:
    ...
    omni ReturnToVendorSlip entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "ReturnToVendorSlip",
                                             ATTRIBUTES_VALUE : {"identifier" : {TYPES_VALUE : STRING_TYPE},
                                                                 "document_status" : {TYPES_VALUE : INTEGER_TYPE},
                                                                 "consignment_return" : {TYPES_VALUE : ["ConsignmentReturn"]},
                                                                 "supplier_return" : {TYPES_VALUE : ["SupplierReturn"]},
