...
class ServiceConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "Service",
                                             ATTRIBUTES_VALUE : {"name" : {TYPES_VALUE : STRING_TYPE},
                                                                 ...
                                                                 "parent_nodes" : {LIST_TYPE_VALUE : True,
                                                                                   TYPES_VALUE : ["MerchandiseHierarchyTreeNode", "Collection", "Category"]},
                                                                 "child_nodes" : {LIST_TYPE_VALUE : True,
                                                                                  TYPES_VALUE : ["Product", "SubProduct"]},
