...
class MediaConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "Media",
                                             ATTRIBUTES_VALUE : {"base_64_data" : {TYPES_VALUE : STRING_TYPE},
                                                                 "label" : {TYPES_VALUE : STRING_TYPE},
                                                                 "mime_type" : {TYPES_VALUE : STRING_TYPE},
                                                                 "entities" : {LIST_TYPE_VALUE : True,
                                                                               TYPES_VALUE : ["CustomerPerson",
                                                                                              ...
                                                                                              "SystemCompany",
                                                                                              "Warehouse"]},
                                                                 "primary_entities" : {LIST_TYPE_VALUE : True,
                                                                                       TYPES_VALUE : ["CustomerPerson",
                                                                                                      "Product",
                                                                                                      "SubProduct",
                                                                                                      "Service",
