...
class DepartmentConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "Department",
                                             ATTRIBUTES_VALUE : {"name" : {TYPES_VALUE : STRING_TYPE},
                                                                 ...
                                                                 "parent_nodes" : {LIST_TYPE_VALUE : True,
                                                                                   TYPES_VALUE : ["OrganizationalHierarchyTreeNode", "SystemCompany",
                                                                                                  "Company", "Store", "Warehouse"]},
                                                                 "child_nodes" : {LIST_TYPE_VALUE : True,
                                                                                  TYPES_VALUE : ["Employee", "Store", "Warehouse"]},
