...
class CreditNoteConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "CreditNote",
                                             ATTRIBUTES_VALUE : {"identifier" : {TYPES_VALUE : STRING_TYPE},
                                                                 "credit_note_status" : {TYPES_VALUE : INTEGER_TYPE},
                                                                 "credit_amount" : {TYPES_VALUE : NUMERIC_TYPE},
                                                                 "document_status" : {TYPES_VALUE : INTEGER_TYPE},
                                                                 "customer_return" : {TYPES_VALUE : ["CustomerReturn"]},
                                                                 "credit_note_payment" : {TYPES_VALUE : ["CreditNotePayment"]},
