...
class InvoiceConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "Invoice",
                                             ATTRIBUTES_VALUE : {"identifier" : {TYPES_VALUE : STRING_TYPE},
                                                                 "document_status" : {TYPES_VALUE : INTEGER_TYPE},
                                                                 "emition_date" : {TYPES_VALUE : DATE_TYPE},
                                                                 "sale_transaction" : {TYPES_VALUE : ["SaleTransaction"]},
                                                                 "purchase_transaction" : {TYPES_VALUE : ["PurchaseTransaction"]},
