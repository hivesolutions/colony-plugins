...
class SupplierReturnConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "SupplierReturn",
                                             ATTRIBUTES_VALUE : {"date" : {TYPES_VALUE : DATE_TYPE},
                                                                 "description" : {TYPES_VALUE : STRING_TYPE},
                                                                 "supplier" : {TYPES_VALUE : ["SupplierCompany"]},
                                                                 "return_to_vendor_slip" : {TYPES_VALUE : ["ReturnToVendorSlip"]},
                                                                 "original_purchase_transaction" : {TYPES_VALUE : ["PurchaseTransaction"]},
