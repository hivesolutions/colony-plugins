...
class StockAdjustmentMerchandiseHierarchyTreeNodeConfiguration:
    ...
    omni StockAdjustmentMerchandiseHierarchyTreeNode entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "StockAdjustmentMerchandiseHierarchyTreeNode",
                                             ATTRIBUTES_VALUE : {"quantity" : {TYPES_VALUE : INTEGER_TYPE},
                                                                 "stock_adjustment" : {TYPES_VALUE : ["StockAdjustment"]},
