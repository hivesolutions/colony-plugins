...
class StockAdjustmentConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "StockAdjustment",
                                             ATTRIBUTES_VALUE : {"date" : {TYPES_VALUE : DATE_TYPE},
                                                                 "identifier" : {TYPES_VALUE : STRING_TYPE},
                                                                 ...
                                                                 "adjustment_owners" : {LIST_TYPE_VALUE : True,
                                                                                        TYPES_VALUE : ["Employee"]},
                                                                 "adjustment_target" : {TYPES_VALUE : ["Store"]},
                                                                 "stock_adjustment_reason" : {TYPES_VALUE : ["StockAdjustmentReason"]},
