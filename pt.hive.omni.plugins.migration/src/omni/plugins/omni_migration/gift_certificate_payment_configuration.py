...
class GiftCertificatePaymentConfiguration:
    ...
    omni GiftCertificatePayment entities.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.intermediate_entity_schemas = [{NAME_VALUE : "GiftCertificatePayment",
                                             ATTRIBUTES_VALUE : {"gift_certificates" : {LIST_TYPE_VALUE : True,
                                                                                        TYPES_VALUE : ["GiftCertificate"]},
                                                                 "payment_lines" : {LIST_TYPE_VALUE : True,
                                                                                    TYPES_VALUE : ["PaymentPaymentMethod"]},
