...
import main_service_smtp_main_authentication_handler_exceptions
...
class MainServiceSmtpMainAuthenticationHandler:
    ...
    main_service_smtp_main_authentication_handler_plugin = None
    """ The main service smtp main authentication handler plugin """

    def __init__(self, main_service_smtp_main_authentication_handler_plugin):
        """
        Constructor of the class.

        @type main_service_smtp_main_authentication_handler_plugin: MainServiceSmtpMainAuthenticationHandlerPlugin
        @param main_service_smtp_main_authentication_handler_plugin: The main service smtp main authentication handler plugin.
        """
