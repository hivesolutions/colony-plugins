...
class MainServiceSmtpMainAuthenticationHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/main_service_smtp_main_authentication_handler/main_authentication_handler/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "main_service_smtp_main_authentication_handler.main_authentication_handler.main_service_smtp_main_authentication_handler_exceptions",
    ...
    """ The main service smtp main authentication handler """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.smtp.main_authentication_handler", "1.0.0")
