...
class ServiceEasypayPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/service_easypay/easypay/resources/baf.xml"}
    capabilities = ["service.easypay", "build_automation_item"]
    capabilities_allowed = []
    dependencies = [colony.base.plugin_system.PluginDependency(
                    "pt.hive.colony.plugins.main.client.http", "1.0.0")]
    events_handled = []
    events_registrable = []
    main_modules = ["service_easypay.easypay.service_easypay_exceptions",
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.service.easypay", "1.0.0")
