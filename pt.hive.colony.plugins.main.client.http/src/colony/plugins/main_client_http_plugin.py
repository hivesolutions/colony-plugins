...
class MainClienthttpPlugin(colony.plugins.plugin_system.Plugin):
    ...
    capabilities = ["startup", "client.http"]
    capabilities_allowed = ["socket_provider"]
    dependencies = [colony.plugins.plugin_system.PluginDependency(
                    "pt.hive.colony.plugins.misc.url_parser", "1.0.0")]
    events_handled = []
    events_registrable = []
    main_modules = ["main_client_http.http.main_client_http_system", "main_client_http.http.main_client_http_exceptions"]
    ...
    def end_load_plugin(self):
        ...
        http_client.fetch_url("http://hive.pt", "GET", {})
