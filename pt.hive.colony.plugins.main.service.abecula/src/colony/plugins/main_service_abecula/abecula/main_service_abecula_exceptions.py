...
class MainServiceAbeculaException(colony.base.plugin_system_exceptions.ColonyException):
    """
...
class AbeculaDataSendingException(AbeculaRuntimeException):
    """
    The abecula data sending exception.
    """
    ...
    def __str__(self):
        ...
        return "Abecula data sending exception: %s" % self.message
