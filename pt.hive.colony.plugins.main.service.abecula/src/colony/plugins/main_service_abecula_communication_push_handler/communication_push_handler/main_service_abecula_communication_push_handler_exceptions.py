...
class MainServiceAbeculaCommunicationPushHandlerException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
    The main service abecula communication push handler exception class.
    """

    message = None
    """ The exception's message """

class OperationNotPermitted(MainServiceAbeculaCommunicationPushHandlerException):
    """
    The operation not permitted class.
    """
