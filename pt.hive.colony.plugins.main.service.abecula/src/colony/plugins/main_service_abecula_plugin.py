...
class MainServiceAbeculaPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Abecula Service Main plugin.
    """

    id = "pt.hive.colony.plugins.main.service.abecula"
    name = "Abecula Service Main Plugin"
    short_name = "Abecula Service Main"
    description = "The plugin that offers the abecula service"
    version = "1.0.0"
    ...
    def load_plugin(self):
        ...
        global main_service_abecula
        import main_service_abecula.abecula.main_service_abecula_system
        self.main_service_abecula = main_service_abecula.abecula.main_service_abecula_system.MainServiceAbecula(self)
    ...
    @colony.base.decorators.load_allowed("pt.hive.colony.plugins.main.service.abecula", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.base.decorators.unload_allowed("pt.hive.colony.plugins.main.service.abecula", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.abecula", "1.0.0")
    ...
    @colony.base.decorators.unload_allowed_capability("abecula_service_handler")
