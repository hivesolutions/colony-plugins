...
class MainServiceAbeculaCommunicationPushHandlerPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_abecula_communication_push_handler.communication_push_handler.main_service_abecula_communication_push_handler_system", "main_service_abecula_communication_push_handler.communication_push_handler.main_service_abecula_communication_push_handler_exceptions"]
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.abecula.communication_push_handler", "1.0.0")
