...
class MainServiceDnsDatabaseHandlerPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.dns.database_handler", "1.0.0")
