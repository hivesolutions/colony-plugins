...
class MainServiceDnsPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    @colony.plugins.decorators.load_allowed("pt.hive.colony.plugins.main.service.dns", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.plugins.decorators.unload_allowed("pt.hive.colony.plugins.main.service.dns", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.dns", "1.0.0")
    ...
    @colony.plugins.decorators.load_allowed_capability("dns_service_handler")
    ...
    @colony.plugins.decorators.unload_allowed_capability("dns_service_handler")
