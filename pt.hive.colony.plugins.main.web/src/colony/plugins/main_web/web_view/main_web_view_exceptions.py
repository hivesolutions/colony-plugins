...
class MainWebViewException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
...
class MainWebViewInvalidWindow(MainWebViewException):
    """
    The main web view invalid window class.
    """
    ...
    def __init__(self, message):
        ...
        MainWebViewException.__init__(self)
    ...
    def __str__(self):
        ...
        return "Entity main web view window is invalid: %s" % self.message
