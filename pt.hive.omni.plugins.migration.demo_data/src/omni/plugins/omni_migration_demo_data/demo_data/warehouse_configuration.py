...
DEMO_DATA_WAREHOUSE_TYPE = "Warehouse"
""" The warehouse type indicator in the demo data """
...
class WarehouseConfiguration:
    ...
    omni Warehouse entities from the demo data.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract warehouse entities from dd_company entities
        dd_company_input_entities = {NAME_VALUE : "DD_Company",
                                     OUTPUT_ENTITIES_VALUE : [{VALIDATORS_VALUE : [{FUNCTION_VALUE : "entity_validator_has_all_attribute_values",
                                                                                    ...
                                                                                    ARGUMENTS_VALUE : {ATTRIBUTES_VALUE : {"Type" : DEMO_DATA_WAREHOUSE_TYPE}}}],
        ...
        # defines how to extract warehouse entities
        self.attribute_mapping_output_entities = [{NAME_VALUE : "Warehouse",
        ...
        # defines how to populate the warehouse entities' addresses relation attribute
        warehouse_addresses_relation = {ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["addresses"],
        ...
        # defines how to populate the warehouse entities' contacts relation attribute
        warehouse_contacts_relation = {ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["contacts"],
                                       RELATED_ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["contactable_organizational_hierarchy_tree_node"],
                                       CONNECTORS_VALUE : [contacts_connector]}

        # connector used to populate the parent nodes relation attribute with company, department, employee, store, system company, warehouse
        ...
        # defines how to populate the warehouse entities' child nodes relation
        warehouse_parent_nodes_relation = {ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["parent_nodes"],
        ...
        # defines how to populate the warehouse entities' media relation
        warehouse_media_relation = {ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["media"],
                                    RELATED_ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["entities"],
                                    CONNECTORS_VALUE : [media_connector]}

        # defines how to connect the extracted warehouse entities with other entities
        self.relation_mapping_entities = [{NAME_VALUE : "Warehouse",
                                           RELATIONS_VALUE : [warehouse_addresses_relation,
                                                              warehouse_contacts_relation,
                                                              warehouse_parent_nodes_relation,
                                                              warehouse_media_relation]}]
        ...
        self.post_conversion_handlers = [{FUNCTION_VALUE : "post_conversion_handler_copy_entity_attributes",
                                          OUTPUT_DEPENDENCIES_VALUE : {"Address" : []},
                                          ARGUMENTS_VALUE : {ENTITY_ATTRIBUTES_MAP_VALUE : {"Warehouse" : {"addresses[0]" : ["primary_address", "primary_address_contactable_organizational_hierarchy_tree_nodes"]}}}},
                                         {FUNCTION_VALUE : "post_conversion_handler_copy_entity_attributes",
                                          OUTPUT_DEPENDENCIES_VALUE : {"ContactInformation" : []},
                                          ARGUMENTS_VALUE : {ENTITY_ATTRIBUTES_MAP_VALUE : {"Warehouse" : {"contacts[0]" : ["primary_contact_information", "primary_contact_information_contactable_organizational_hierarchy_tree_nodes"]}}}},
                                         {FUNCTION_VALUE : "post_conversion_handler_copy_entity_attributes",
                                          OUTPUT_DEPENDENCIES_VALUE : {"Media" : []},
                                          ARGUMENTS_VALUE : {ENTITY_ATTRIBUTES_MAP_VALUE : {"Warehouse" : {"media[0]" : ["primary_media", "primary_entities"]}}}}]
