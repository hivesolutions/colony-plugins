...
class MerchandiseHierarchyTreeConfiguration:
    ...
    omni MerchandiseHierarchyTree entities from the demo data.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        self.post_conversion_handlers = [{FUNCTION_VALUE : generic_configuration_handlers.post_conversion_handler_create_tree,
                                          ARGUMENTS_VALUE : {TREE_ENTITY_NAME_VALUE : "MerchandiseHierarchyTree",
                                                             ROOT_TREE_NODE_ENTITY_NAME_VALUE : "MerchandiseHierarchyTreeNode",
                                                             CHILD_TREE_NODE_ENTITY_NAMES_VALUE : ["Category", "Collection", "Product", "Service"]}}]
