...
DEMO_DATA_COLLECTION_TYPE = "collection"
""" The collection type in the demo data """
...
class CollectionConfiguration:
    ...
    omni Collection entities from the demo data.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract collection entities from dd_merchandise entities
        dd_merchandise_input_entities = {NAME_VALUE : "DD_Merchandise",
                                         OUTPUT_ENTITIES_VALUE : [{VALIDATORS_VALUE : [{FUNCTION_VALUE : "entity_validator_has_all_attribute_values",
                                                                                        ...
                                                                                        ARGUMENTS_VALUE : {ATTRIBUTES_VALUE : {"Type" : DEMO_DATA_COLLECTION_TYPE}}}],
        ...
        # defines how to extract collection entities
        self.attribute_mapping_output_entities = [{NAME_VALUE : "Collection",
