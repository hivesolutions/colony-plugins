...
DEMO_DATA_DEPARTMENT_TYPE = "Department"
""" The department type indicator in the demo data """
...
class DepartmentConfiguration:
    ...
    omni Department entities from the demo data.
    """
    ...
    def load_data_converter_configuration(self):
        ...
        # defines how to extract department entities from dd_company entities
        dd_company_input_entities = {NAME_VALUE : "DD_Company",
                                     OUTPUT_ENTITIES_VALUE : [{VALIDATORS_VALUE : [{FUNCTION_VALUE : "entity_validator_has_all_attribute_values",
                                                                                    ...
                                                                                    ARGUMENTS_VALUE : {ATTRIBUTES_VALUE : {"Type" : DEMO_DATA_DEPARTMENT_TYPE}}}],
        ...
        # defines how to extract department entities
        self.attribute_mapping_output_entities = [{NAME_VALUE : "Department",
        ...
        # defines how to populate the department entities' addresses relation attribute
        department_addresses_relation = {ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["addresses"],
        ...
        # defines how to populate the department entities' contacts relation attribute
        department_contacts_relation = {ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["contacts"],
                                     RELATED_ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["contactable_organizational_hierarchy_tree_node"],
                                     CONNECTORS_VALUE : [contacts_connector]}

        # connector used to populate the child nodes relation attribute with warehouse, company, store and employee entities
        ...
        # defines how to populate the department entities' child nodes relation
        department_parent_nodes_relation = {ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["parent_nodes"],
                                            RELATED_ENTITY_RELATION_ATTRIBUTE_NAMES_VALUE : ["child_nodes"],
                                            CONNECTORS_VALUE : [parent_nodes_connector]}

        # defines how to connect the extracted department entities with other entities
        self.relation_mapping_entities = [{NAME_VALUE : "Department",
                                           RELATIONS_VALUE : [department_addresses_relation,
                                                              department_contacts_relation,
                                                              department_parent_nodes_relation]}]
        ...
        self.post_conversion_handlers = [{FUNCTION_VALUE : "post_conversion_handler_copy_entity_attributes",
                                          OUTPUT_DEPENDENCIES_VALUE : {"Address" : []},
                                          ARGUMENTS_VALUE : {ENTITY_ATTRIBUTES_MAP_VALUE : {"Department" : {"addresses[0]" : ["primary_address", "primary_address_contactable_organizational_hierarchy_tree_nodes"]}}}},
                                         {FUNCTION_VALUE : "post_conversion_handler_copy_entity_attributes",
                                          OUTPUT_DEPENDENCIES_VALUE : {"ContactInformation" : []},
                                          ARGUMENTS_VALUE : {ENTITY_ATTRIBUTES_MAP_VALUE : {"Department" : {"contacts[0]" : ["primary_contact_information", "primary_contact_information_contactable_organizational_hierarchy_tree_nodes"]}}}}]
