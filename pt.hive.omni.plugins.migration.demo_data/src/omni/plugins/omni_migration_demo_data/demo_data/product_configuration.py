...
DEMO_DATA_PRODUCT_TYPE = "product"
""" The product type in the demo data """
...
class ProductConfiguration:
    ...
    def load_data_converter_configuration(self):
        ...
        dd_merchandise_input_entities = {NAME_VALUE : "DD_Merchandise",
                                         OUTPUT_ENTITIES_VALUE : [{VALIDATORS_VALUE : [{FUNCTION_VALUE : "entity_validator_has_all_attribute_values",
                                                                                        ...
                                                                                        ARGUMENTS_VALUE : {ATTRIBUTES_VALUE : {"Type" : DEMO_DATA_PRODUCT_TYPE}}}],
        ...
        # connector used to populate the child nodes relation attribute with category entities
        ...
        # defines how to populate the product entities' child nodes relation
        ...
        # defines how to populate the product entities' parent nodes relation
        ...
        # defines how to connect the extracted product entities with other entities
        ...
        self.post_conversion_handlers = [{FUNCTION_VALUE : self.post_conversion_handler_mark_sellable_products,
    ...
    def post_conversion_handler_mark_sellable_products(self, data_converter, input_intermediate_structure, output_intermediate_structure, arguments):
        self.omni_migration_demo_data_plugin.info("Setting products' sellable status")

        # marks each product as sellable or not sellable
        product_entities = output_intermediate_structure.get_entities_by_name("Product")
        for product_entity in product_entities:

            # marks the product has sellable only if it has no child nodes
            sellable = OMNI_SELLABLE_TRANSACTIONAL_MERCHANDISE
            child_nodes = product_entity.get_attribute("child_nodes")
            if child_nodes:
                sellable = OMNI_NON_SELLABLE_TRANSACTIONAL_MERCHANDISE
            product_entity.set_attribute("sellable", sellable)
