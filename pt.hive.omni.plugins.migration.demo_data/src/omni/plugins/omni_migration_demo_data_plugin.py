...
class OmniMigrationDemoData(colony.plugins.plugin_system.Plugin):
    """
    Configuration used to migrate data from demo data to omni.
    """

    id = "pt.hive.omni.plugins.migration.demo_data"
    name = "Demo Data to Omni Migration Plugin"
    short_name = "Demo Data to Omni Migration"
    description = "Configuration used to migrate data from demo data to omni"
    version = "1.0.0"
    ...
    demo_data_configuration = None
    """ The demo data to omni migration configuration """
    ...
    def load_plugin(self):
        ...
        global omni_migration_demo_data
        import omni_migration_demo_data.demo_data.omni_migration_demo_data_system
        self.demo_data_configuration = omni_migration_demo_data.demo_data.omni_migration_demo_data_system.OmniMigrationDemoData(self)

    def end_load_plugin(self):
        colony.plugins.plugin_system.Plugin.end_load_plugin(self)
        self.demo_data_configuration.load_data_converter_configuration()

    def unload_plugin(self):
        colony.plugins.plugin_system.Plugin.unload_plugin(self)
        self.demo_data_configuration = None

    def end_unload_plugin(self):
        colony.plugins.plugin_system.Plugin.end_unload_plugin(self)

    @colony.plugins.decorators.load_allowed("pt.hive.omni.plugins.migration.demo_data", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.plugins.decorators.unload_allowed("pt.hive.omni.plugins.migration.demo_data", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.plugins.decorators.inject_dependencies("pt.hive.omni.plugins.migration.demo_data", "1.0.0")
    ...
    def get_intermediate_entity_schemas(self):
        ...
        return self.demo_data_configuration.get_intermediate_entity_schemas()
    ...
    def get_attribute_mapping_output_entities(self):
        ...
        return self.demo_data_configuration.get_attribute_mapping_output_entities()
    ...
    def get_relation_mapping_entities(self):
        ...
        return self.demo_data_configuration.get_relation_mapping_entities()
    ...
    def get_post_attribute_mapping_handlers(self):
        ...
        return self.demo_data_configuration.get_post_attribute_mapping_handlers()
    ...
    def get_post_relation_mapping_handlers(self):
        ...
        return self.demo_data_configuration.get_post_relation_mapping_handlers()
    ...
    def get_post_conversion_handlers(self):
        ...
        return self.demo_data_configuration.get_post_conversion_handlers()
    ...
    def get_input_entity_indexers(self):
        ...
        return self.demo_data_configuration.get_input_entity_indexers()
    ...
    def get_output_entity_indexers(self):
        ...
        return self.demo_data_configuration.get_output_entity_indexers()
    ...
    def get_input_io_adapters_options(self):
        ...
        return self.demo_data_configuration.get_input_io_adapters_options()
    ...
    def get_output_io_adapters_options(self):
        ...
        return self.demo_data_configuration.get_output_io_adapters_options()
