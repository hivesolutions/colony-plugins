...
class MainServiceHttpWelcomeHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_http_welcome_handler/welcome_handler/resources/baf.xml"}
    capabilities = ["build_automation_item"]
    capabilities_allowed = []
    dependencies = []
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_http_welcome_handler.welcome_handler.main_service_http_welcome_handler_system"]
