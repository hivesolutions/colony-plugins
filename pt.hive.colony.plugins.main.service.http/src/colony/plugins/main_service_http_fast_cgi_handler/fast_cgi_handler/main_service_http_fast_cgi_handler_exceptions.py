...
class MainServiceHttpFastCgiHandlerException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
    The main service http fast cgi handler exception class.
    """

    message = None
    """ The exception's message """

class RequestNotHandled(MainServiceHttpFastCgiHandlerException):
    """
...
class InvalidFastCgiHeader(MainServiceHttpFastCgiHandlerException):
    """
