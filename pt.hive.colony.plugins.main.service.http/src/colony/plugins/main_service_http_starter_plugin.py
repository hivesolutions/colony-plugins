...
class MainServiceHttpStarterPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/main_service_http_starter/starter/resources/baf.xml"
    }
    capabilities = [
        "main",
    ...
    dependencies = [
        colony.base.plugin_system.PluginDependency("pt.hive.colony.plugins.main.service.http", "1.0.0")
    ]
    main_modules = [
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.starter", "1.0.0")
