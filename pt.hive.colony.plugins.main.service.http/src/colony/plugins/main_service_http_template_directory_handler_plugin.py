...
class MainServiceHttpTemplateDirectoryListHandlerPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_http_template_directory_list_handler/template_directory_list_handler/resources/baf.xml"}
    capabilities = ["http_service_directory_list_handler", "build_automation_item"]
    capabilities_allowed = []
    dependencies = [colony.base.plugin_system.PluginDependency(
                    "pt.hive.colony.plugins.template_engine.manager", "1.0.0")]
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_http_template_directory_list_handler.template_directory_list_handler.main_service_http_template_directory_list_handler_system"]
    ...
    def load_plugin(self):
        ...
        global main_service_http_template_directory_list_handler
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.template_directory_list_handler", "1.0.0")
