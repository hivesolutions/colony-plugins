...
class MainServiceHttpMainAuthenticationHandlerPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_http_main_authentication_handler/main_authentication_handler/resources/baf.xml"}
    capabilities = ["http_service_authentication_handler", "build_automation_item"]
    capabilities_allowed = []
    dependencies = [colony.base.plugin_system.PluginDependency(
                    "pt.hive.colony.plugins.main.authentication", "1.0.0")]
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_http_main_authentication_handler.main_authentication_handler.main_service_http_main_authentication_handler_exceptions",
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.main_authentication_handler", "1.0.0")
