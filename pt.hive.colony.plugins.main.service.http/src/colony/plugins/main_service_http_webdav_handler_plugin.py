...
class MainServiceHttpWebdavHandlerPlugin(colony.plugins.plugin_system.Plugin):
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_http_webdav_handler.webdav_handler.main_service_http_webdav_handler_system", "main_service_http_webdav_handler.webdav_handler.main_service_http_webdav_handler_exceptions"]
