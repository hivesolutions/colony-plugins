...
class MainServiceHttpFastCgiHandlerPlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Http Service Main Fast Cgi Handler plugin.
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_http_fast_cgi_handler/fast_cgi_handler/resources/baf.xml"}
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_http_fast_cgi_handler.fast_cgi_handler.main_service_http_fast_cgi_handler_system", "main_service_http_fast_cgi_handler.fast_cgi_handler.main_service_http_fast_cgi_handler_exceptions"]
    ...
    def load_plugin(self):
        ...
        global main_service_http_fast_cgi_handler
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.fast_cgi_handler", "1.0.0")
    ...
    def get_handler_name(self):
        ...
        return self.main_service_http_fast_cgi_handler.get_handler_name()
