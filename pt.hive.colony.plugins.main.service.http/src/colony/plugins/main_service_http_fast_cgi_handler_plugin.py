...
class MainServiceHttpFastCgiHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/main_service_http_fast_cgi_handler/fast_cgi_handler/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "main_service_http_fast_cgi_handler.fast_cgi_handler.main_service_http_fast_cgi_handler_exceptions",
    ...
    """ The main service http fast cgi handler """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.fast_cgi_handler", "1.0.0")
