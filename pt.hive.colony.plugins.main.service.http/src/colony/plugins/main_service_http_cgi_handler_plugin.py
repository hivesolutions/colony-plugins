...
class MainServiceHttpCgiHandlerPlugin(colony.base.plugin_system.Plugin):
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_http_cgi_handler.cgi_handler.main_service_http_cgi_handler_exceptions",
                    "main_service_http_cgi_handler.cgi_handler.main_service_http_cgi_handler_system"]
