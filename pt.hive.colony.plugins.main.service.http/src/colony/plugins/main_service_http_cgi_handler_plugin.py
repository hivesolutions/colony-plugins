...
class MainServiceHttpCgiHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_http_cgi_handler/cgi_handler/resources/baf.xml"}
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_http_cgi_handler.cgi_handler.main_service_http_cgi_handler_exceptions", "main_service_http_cgi_handler.cgi_handler.main_service_http_cgi_handler_system"]
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.cgi_handler", "1.0.0")
