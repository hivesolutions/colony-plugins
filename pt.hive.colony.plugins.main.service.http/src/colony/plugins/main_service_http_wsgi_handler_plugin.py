...
class MainServiceHttpWsgiHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_http_wsgi_handler/wsgi_handler/resources/baf.xml"}
    ...
    def load_plugin(self):
        ...
        global main_service_http_wsgi_handler
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.wsgi_handler", "1.0.0")
