...
class MainServiceHttpCgiHandlerException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
    The main service http cgi handler exception class.
    """

    message = None
    """ The exception's message """

class RequestNotHandled(MainServiceHttpCgiHandlerException):
    """
