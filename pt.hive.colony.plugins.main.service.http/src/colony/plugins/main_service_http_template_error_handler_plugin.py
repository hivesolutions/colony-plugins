...
class MainServiceHttpTemplateErrorHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.template_error_handler", "1.0.0")
