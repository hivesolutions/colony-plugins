...
class MainServiceHttpColonyHandlerException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
...
class RequestNotHandled(MainServiceHttpColonyHandlerException):
    ...
    def __init__(self, message):
        ...
        MainServiceHttpColonyHandlerException.__init__(self)
