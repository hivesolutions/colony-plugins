...
class MainServiceHttpSystemInformationHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    name = "Http Service Main System Information Handler Plugin"
    short_name = "Http Service Main System Information Handler"
    ...
    def load_plugin(self):
        ...
        global main_service_http_system_information_handler
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.http.system_information_handler", "1.0.0")
