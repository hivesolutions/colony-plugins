...
class BusinessDummyEntityPlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Business Dummy Entity plugin
    """

    id = "pt.hive.colony.plugins.business.dummy_entity"
    ...
    dependencies = [colony.plugins.plugin_system.PluginDependency(
                    ...
                    "pt.hive.colony.plugins.business.dummy_entity_bundle", "1.0.0")]
    events_handled = []
    events_registrable = []
    ...
    def load_plugin(self):
        ...
        global business
        import business.dummy_entity.business_dummy_entity_system
        self.business_dummy_entity = business.dummy_entity.business_dummy_entity_system.BusinessDummyEntity(self)
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.business.dummy_entity", "1.0.0")
    ...
    @colony.plugins.decorators.plugin_inject("pt.hive.colony.plugins.business.dummy_entity_bundle")
