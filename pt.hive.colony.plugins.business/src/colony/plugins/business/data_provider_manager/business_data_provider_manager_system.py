...
class BusinessDataProviderManager:
    """
    The business data provider manager class.
    """

    business_data_provider_manager_plugin = None
    """ The business data provider manager plugin """
    ...
    def __init__(self, business_data_provider_manager_plugin):
        ...
        self.business_data_provider_manager_plugin = business_data_provider_manager_plugin
