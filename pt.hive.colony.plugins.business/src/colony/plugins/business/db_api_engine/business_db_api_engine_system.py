...
class BusinessDbApiEngine:
    """
    The business db api engine class
    """

    business_db_api_engine_plugin = None
    """ The business db api engine plugin """
    ...
    def __init__(self, business_db_api_engine_plugin):
        ...
        self.business_db_api_engine_plugin = business_db_api_engine_plugin
