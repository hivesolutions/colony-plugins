...
class BusinessMetadataProvider:
    """
    The business metadata provider class.
    """

    business_metadata_provider_plugin = None
    """ The business metadata provider plugin """
    ...
    def __init__(self, business_metadata_provider_plugin):
        ...
        self.business_metadata_provider_plugin = business_metadata_provider_plugin
