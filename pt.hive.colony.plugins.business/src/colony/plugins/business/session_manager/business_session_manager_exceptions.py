...
class BusinessSessionManagerException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
...
class InvalidSessionId(BusinessSessionManagerException):
    ...
    def __str__(self):
        ...
        return "Invalid session id: %s" % self.message
