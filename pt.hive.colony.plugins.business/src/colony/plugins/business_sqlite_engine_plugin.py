...
class BusinessSqliteEnginePlugin(colony.plugins.plugin_system.Plugin):
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.business.sqlite_engine", "1.0.0")
    ...
    def find_entity_options(self, connection, entity_class, id_value, options):
        return self.business_sqlite_engine.find_entity_options(connection, entity_class, id_value, options = options)
