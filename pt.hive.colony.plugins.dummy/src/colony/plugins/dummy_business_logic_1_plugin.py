...
class DummyBusinessLogic1Plugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.dummy.business_logic_1", "1.0.0")
