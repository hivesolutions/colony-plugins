...
class DummyEntityManagerPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Dummy Entity Manager plugin.
    """

    id = "pt.hive.colony.plugins.dummy.entity_manager"
    name = "Dummy Entity Manager Plugin"
    short_name = "Dummy Entity Manager"
    description = "Dummy Entity Manager Plugin"
    version = "1.0.0"
    ...
    def end_load_plugin(self):
        ...
        self.dummy_entity_manager.test_entity_manager()
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.dummy.entity_manager", "1.0.0")
    ...
    @colony.base.decorators.plugin_inject("pt.hive.colony.plugins.business.dummy.entity")
    def set_business_dummy_entity_plugin(self, business_dummy_entity_plugin):
