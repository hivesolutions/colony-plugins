...
class DummyBusinessLogicPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.dummy.business_logic", "1.0.0")
    ...
    @colony.base.decorators.plugin_inject("pt.hive.colony.plugins.dummy.database_access")
