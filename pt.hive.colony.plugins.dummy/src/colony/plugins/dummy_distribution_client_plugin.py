...
class DummyDistributionClientPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/dummy/distribution_client/resources/baf.xml"
    }
    capabilities = [
        "dummy_distribution_client",
        "build_automation_item"
    ]
    dependencies = [
        colony.base.plugin_system.PluginDependency("pt.hive.colony.plugins.distribution.client", "1.0.0")
    ]
    main_modules = [
        "dummy.distribution_client.dummy_distribution_client_system"
    ]

    dummy_distribution_client = None
    """ The dummy distribution client """
    ...
    def end_load_plugin(self):
        ...
        self.dummy_distribution_client.test_get_remote_client_references()
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.dummy.distribution_client", "1.0.0")
    ...
    @colony.base.decorators.plugin_inject("pt.hive.colony.plugins.distribution.client")
