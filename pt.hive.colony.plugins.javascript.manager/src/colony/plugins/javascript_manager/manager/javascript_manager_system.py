...
class JavascriptManager:
    ...
    def set_plugin_search_directories(self):
        ...
        self.plugin_search_directories_list = [self.workspace_base_path + "/pt.hive.colony.demo.web.plugins.pacman.gui/plugins",
                                               ...
                                               self.workspace_base_path + "/pt.hive.colony.web.plugins.gui.component.tabpanel/plugins",
                                               ...
                                               self.workspace_base_path + "/pt.hive.omni.web.plugins.gui.main_view/plugins",
