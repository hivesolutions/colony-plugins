<div id="wiki-page-new-container">
    <div id="wiki-page-new">
        ...
        <div class="wiki-page-new-line">
            <input id="wiki-summary-input" name="wiki-name-input" class="wiki-input" type="text" value="Describe your new page" current_status="" original_value="Describe your new page" />
        </div>
