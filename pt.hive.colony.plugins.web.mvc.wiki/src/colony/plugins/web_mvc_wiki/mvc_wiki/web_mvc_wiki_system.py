...
class WebMvcWiki:
    ...
    def get_patterns(self):
        ...
        return (
            ...
            (r"^wiki/(?P<instance_name>[a-zA-Z]+)/pages/(?P<page_name>[a-zA-Z0-9_:\.]*)$", self.web_mvc_wiki_page_controller.handle_show, ("get", "post")),
            ...
            (r"^wiki/(?P<instance_name>[a-zA-Z]+)/pages/(?P<page_name>[a-zA-Z0-9_:\.]+)/edit$", self.web_mvc_wiki_page_controller.handle_edit, ("get", "post")),
            (r"^wiki/(?P<instance_name>[a-zA-Z]+)/pages/(?P<page_name>[a-zA-Z0-9_:\.]+)/update$", self.web_mvc_wiki_page_controller.handle_update, "post"),
            (r"^wiki/(?P<instance_name>[a-zA-Z]+)/(?P<page_name>[a-zA-Z0-9_:\.]*)$", self.web_mvc_wiki_page_controller.handle_show, ("get", "post")),
