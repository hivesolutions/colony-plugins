...
class ColonyDeployerPlugin(colony.base.plugin_system.Plugin):
    ...
    def deploy_container(self, container_id, container_version, contents_file, transaction_properties):
        ...
        return self.colony_deployer.deploy_container(container_id, container_version, contents_file, transaction_properties)
    ...
    def undeploy_container(self, container_id, container_version, transaction_properties):
        ...
        return self.colony_deployer.undeploy_container(container_id, container_version, transaction_properties)
