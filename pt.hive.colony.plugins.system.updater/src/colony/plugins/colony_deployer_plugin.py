...
class ColonyDeployerPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/system_updater/colony_deployer/resources/baf.xml"}
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["system_updater.colony_deployer.colony_deployer_exceptions",
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.system.updater.colony_deployer", "1.0.0")
