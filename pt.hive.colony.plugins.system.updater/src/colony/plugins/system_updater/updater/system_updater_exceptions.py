...
class SystemUpdaterException(colony.base.plugin_system_exceptions.ColonyException):
    """
    The system updater exception class.
    """
...
class InvalidPackageException(SystemUpdaterException):
    ...
    def __str__(self):
        ...
        return "Invalid package: %s" % self.message
...
class InvalidContainerException(SystemUpdaterException):
    """
    The invalid container exception class.
    """
    ...
    def __str__(self):
        ...
        return "Invalid container: %s" % self.message
