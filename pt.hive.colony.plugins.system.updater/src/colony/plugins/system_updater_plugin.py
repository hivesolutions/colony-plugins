...
class SystemUpdaterPlugin(colony.base.plugin_system.Plugin):
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["system_updater.updater.exceptions.system_updater_exceptions",
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.system.updater", "1.0.0")
