...
class ColonyPackingInstallerDeployerPlugin(colony.base.plugin_system.Plugin):
    ...
    def deploy_bundle(self, bundle_id, bundle_version, contents_file):
        ...
        return self.colony_packing_installer_deployer.deploy_bundle(bundle_id, bundle_version, contents_file)
    ...
    def deploy_plugin(self, plugin_id, plugin_version, contents_file):
        ...
        return self.colony_packing_installer_deployer.deploy_plugin(plugin_id, plugin_version, contents_file)
