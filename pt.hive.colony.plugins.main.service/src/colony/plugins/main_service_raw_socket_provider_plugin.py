...
class MainServiceRawSocketProviderPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_raw_socket_provider/raw_socket_provider/resources/baf.xml"}
    capabilities = ["socket_provider", "build_automation_item"]
    capabilities_allowed = []
    dependencies = []
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_raw_socket_provider.raw_socket_provider.main_service_raw_socket_provider_system"]

    main_service_raw_socket_provider = None

    def load_plugin(self):
        colony.plugins.plugin_system.Plugin.load_plugin(self)
        global main_service_raw_socket_provider
