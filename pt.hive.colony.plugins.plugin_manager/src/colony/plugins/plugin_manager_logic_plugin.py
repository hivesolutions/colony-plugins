...
class PluginManagerLogicPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.plugin_manager_logic", "1.0.0")
