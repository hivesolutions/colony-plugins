...
class BitmapLoaderPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/misc/bitmap_loader/resources/baf.xml"
    }
    capabilities = [
        "bitmap_load",
    ...
    main_modules = [
        "misc.bitmap_loader.bitmap_loader_system"
    ]
    ...
    def load_icons(self, path, bitmaps_map, icons_map):
        return self.bitmap_loader.load_icons(path, bitmaps_map, icons_map)
