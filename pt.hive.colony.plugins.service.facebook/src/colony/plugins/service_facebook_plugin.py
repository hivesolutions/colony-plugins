...
class ServiceFacebookPlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Facebook Service plugin.
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/service_facebook/facebook/resources/baf.xml"}
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.service.facebook", "1.0.0")
