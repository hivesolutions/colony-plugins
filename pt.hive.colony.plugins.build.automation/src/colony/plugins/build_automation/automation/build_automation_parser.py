...
class Build:
    ...
    def __init__(self, default_stage = "none", execution_directory = "none", target_directory = "none", output_directory = "none", source_directory = "none", final_name = "none", clean_target_directory = "none"):
