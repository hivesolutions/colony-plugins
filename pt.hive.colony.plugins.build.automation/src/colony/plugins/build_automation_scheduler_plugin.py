...
class BuildAutomationSchedulerPlugin(colony.base.plugin_system.Plugin):
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["build_automation.scheduler.build_automation_scheduler_system", "build_automation.scheduler.console_build_automation_scheduler"]
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.build.automation.scheduler", "1.0.0")
