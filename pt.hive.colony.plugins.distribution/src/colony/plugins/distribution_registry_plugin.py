...
class DistributionRegistryPlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Distribution Registry plugin.
    """

    id = "pt.hive.colony.plugins.distribution.registry"
    name = "Distribution Registry Plugin"
    short_name = "Distribution Registry"
    description = "Distribution Registry Plugin"
    version = "1.0.0"
    author = "Hive Solutions"
    loading_type = colony.plugins.plugin_system.EAGER_LOADING_TYPE
    platforms = [colony.plugins.plugin_system.CPYTHON_ENVIRONMENT]
    capabilities = ["distribution_registry"]
