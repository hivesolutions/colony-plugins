...
class DistributionMdnsDiscoveryPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Distribution Mdns Discovery plugin.
    """

    id = "pt.hive.colony.plugins.distribution.mdns.discovery"
    name = "Distribution Mdns Discovery Plugin"
    short_name = "Distribution Mdns Discovery"
    description = "Distribution Mdns Discovery Plugin"
    version = "1.0.0"
    ...
    main_modules = [
        "distribution.mdns_discovery.distribution_mdns_discovery_system"
    ]

    distribution_mdns_discovery = None
    """ The distribution mdns discovery """
    ...
    def load_plugin(self):
        ...
        import distribution.mdns_discovery.distribution_mdns_discovery_system
        self.distribution_mdns_discovery = distribution.mdns_discovery.distribution_mdns_discovery_system.DistributionMdnsDiscovery(self)
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.distribution.mdns.discovery", "1.0.0")
    ...
    def get_adapter_name(self):
        ...
        return self.distribution_mdns_discovery.get_adapter_name()
