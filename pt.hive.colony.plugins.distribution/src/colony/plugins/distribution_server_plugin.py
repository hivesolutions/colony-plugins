...
class DistributionServerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.load_allowed("pt.hive.colony.plugins.distribution.server", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.base.decorators.unload_allowed("pt.hive.colony.plugins.distribution.server", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.distribution.server", "1.0.0")
    def dependency_injected(self, plugin):
        colony.base.plugin_system.Plugin.dependency_injected(self, plugin)

    @colony.base.decorators.load_allowed_capability("distribution_server_adapter")
    ...
    @colony.base.decorators.unload_allowed_capability("distribution_server_adapter")
