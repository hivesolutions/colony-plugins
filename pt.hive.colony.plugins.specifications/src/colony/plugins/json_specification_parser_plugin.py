...
class JsonSpecificationParserPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/specifications/json_specification_parser/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "specifications.json_specification_parser.json_specification_parser_exceptions",
        "specifications.json_specification_parser.json_specification_parser_system"
    ]

    json_specification_parser = None
    """ The json specification parser """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.specifications.json_specification_parser", "1.0.0")
