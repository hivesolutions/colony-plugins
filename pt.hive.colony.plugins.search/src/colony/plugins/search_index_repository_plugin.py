...
class SearchIndexRepositoryPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/search/index_repository/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "search.index_repository.search_index_repository_exceptions",
    ...
    def has_index(self, search_index_identifier):
        return self.search_index_repository.has_index(search_index_identifier)
