...
class SearchException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
...
class InvalidFunctionRequested(SearchException):
    """
    The invalid function request class.
    """
    ...
    def __str__(self):
        ...
        return "Invalid function requested: %s" % self.message
