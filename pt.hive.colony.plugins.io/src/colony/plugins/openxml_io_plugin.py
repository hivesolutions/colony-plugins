...
class OpenXMLInputOutputPlugin(colony.plugins.plugin_system.Plugin):
    """
    Provides a simple API to interface with OpenXML files
    """

    id = "pt.hive.colony.plugins.io.openxml"
    name = "OpenXML I/O plugin"
    short_name = "OpenXML plugin"
    description = "Provides a simple API to manipulate OpenXML files"
    version = "1.0.0"
    author = "Hive Solutions"
    loading_type = colony.plugins.plugin_system.EAGER_LOADING_TYPE
    platforms = [colony.plugins.plugin_system.CPYTHON_ENVIRONMENT]
    capabilities = ["io.openxml"]
    ...
    def load_plugin(self):
        ...
        global io
        import io.openxml.openxml_io
        self.codebase = io.openxml.openxml_io.OpenXMLInputOutput(self)
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.io.openxml", "1.0.0")
    ...
    def open(self, document_path):
        ...
        @rtype: OpenXMLFile
        @return: OpenXML document descriptor.
        """
        
        return self.codebase.open(document_path)
    ...
    def close(self, document_path):
        ...
        self.codebase.close(document_path)