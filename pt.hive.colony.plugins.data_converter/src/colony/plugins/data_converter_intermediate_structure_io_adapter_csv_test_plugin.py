...
class DataConverterInputOutputCsvTestPlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Data Converter Io Adapter Csv Test plugin.
    """

    id = "pt.hive.colony.plugins.data_converter.intermediate_structure.io_adapter.csv_test"
    name = "Data Converter Intermediate Structure Io Adapter Csv Test Plugin"
    short_name = "Data Converter Intermediate Structure Io Adapter Csv Test"
    description = "Data Converter Intermediate Structure Io Adapter Csv Test Plugin"
    version = "1.0.0"
    ...
    io_adapter_csv_test = None
    """ The csv input output adapter """
    ...
    def load_plugin(self):
        ...
        import data_converter_intermediate_structure_io_adapter_csv.test.io_adapter_csv_test
        self.io_adapter_csv_test = data_converter_intermediate_structure_io_adapter_csv.test.io_adapter_csv_test.IoAdapterCsvTest(self)
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.data_converter.intermediate_structure.io_adapter.csv_test", "1.0.0")
    def dependency_injected(self, plugin):
        colony.plugins.plugin_system.Plugin.dependency_injected(self, plugin)

    def get_plugin_test_case_bundle(self):
        return self.io_adapter_csv_test.get_plugin_test_case_bundle()
