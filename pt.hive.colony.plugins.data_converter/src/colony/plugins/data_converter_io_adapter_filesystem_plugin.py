...
class DataConverterIoAdapterFilesystemPlugin(colony.plugins.plugin_system.Plugin):
    ...
    capabilities = ["data_converter_io_adapter.filesystem"]
    ...
    def load_intermediate_structure(self, intermediate_structure, options):
        ...
        self.io_adapter_filesystem.load_intermediate_structure(intermediate_structure, options)
    ...
    def save_intermediate_structure(self, intermediate_structure, options):
        ...
        self.io_adapter_filesystem.save_intermediate_structure(intermediate_structure, options)
