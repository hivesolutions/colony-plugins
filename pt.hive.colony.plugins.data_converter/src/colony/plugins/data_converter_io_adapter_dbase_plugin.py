...
class DataConverterIoAdapterDbasePlugin(colony.plugins.plugin_system.Plugin):
    ...
    capabilities = ["data_converter_io_adapter.dbase"]
    ...
    def load_intermediate_structure(self, intermediate_structure, options):
        ...
        return self.io_adapter_dbase.load_intermediate_structure(intermediate_structure, options)
    ...
    def save_intermediate_structure(self, intermediate_structure, options):
        ...
        return self.io_adapter_dbase.save_intermediate_structure(intermediate_structure, options)
