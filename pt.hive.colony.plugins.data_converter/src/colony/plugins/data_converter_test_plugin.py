...
class DataConverterTestPlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Data Converter Test plugin.
    """

    id = "pt.hive.colony.plugins.data_converter_test"
    name = "Data Converter Test Plugin"
    short_name = "Data Converter Test"
    description = "Data Converter Test Plugin"
    version = "1.0.0"
    ...
    dependencies = [colony.plugins.plugin_system.PluginDependency(
                    "pt.hive.colony.plugins.data_converter", "1.0.0"),
    ...
    data_converter_test = None
    """ The data converter tests """
    ...
    def load_plugin(self):
        ...
        import data_converter.test.data_converter_test
        self.data_converter_test = data_converter.test.data_converter_test.DataConverterTest(self)
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.data_converter_test", "1.0.0")
    def dependency_injected(self, plugin):
        colony.plugins.plugin_system.Plugin.dependency_injected(self, plugin)

    def get_plugin_test_case_bundle(self):
        return self.data_converter_test.get_plugin_test_case_bundle()

    def get_data_converter_plugin(self):
        return self.data_converter_plugin

    @colony.plugins.decorators.plugin_inject("pt.hive.colony.plugins.data_converter")
    def set_data_converter_plugin(self, data_converter_plugin):
    ...
    @colony.plugins.decorators.plugin_inject("pt.hive.colony.plugins.data_converter.intermediate_structure.io_adapter.pickle")
    def set_io_adapter_pickle_plugin(self, io_adapter_pickle_plugin):
