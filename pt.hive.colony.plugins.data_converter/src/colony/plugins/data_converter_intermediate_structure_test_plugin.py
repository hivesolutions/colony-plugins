...
class DataConverterIntermediateStructureTestPlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Data Converter Intermediate Structure Test plugin.
    """

    id = "pt.hive.colony.plugins.data_converter.intermediate_structure_test"
    name = "Data Converter Intermediate Structure Test Plugin"
    short_name = "Data Converter Intermediate Structure Test"
    description = "Data Converter Intermediate Structure Test Plugin"
    version = "1.0.0"
    ...
    intermediate_structure_test = None
    """ The intermediate structure's tests """
    ...
    def load_plugin(self):
        ...
        import data_converter_intermediate_structure.test.intermediate_structure_test
        self.intermediate_structure_test = data_converter_intermediate_structure.test.intermediate_structure_test.IntermediateStructureTest(self)
    ...
    def unload_plugin(self):
        ...
        self.intermediate_structure_test = None
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.data_converter.intermediate_structure_test", "1.0.0")
    def dependency_injected(self, plugin):
        colony.plugins.plugin_system.Plugin.dependency_injected(self, plugin)

    def get_plugin_test_case_bundle(self):
        return self.intermediate_structure_test.get_plugin_test_case_bundle()
