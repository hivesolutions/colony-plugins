...
class DataConverterIoAdapterPicklePlugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.load_allowed("pt.hive.colony.plugins.data_converter.io_adapter.pickle", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.base.decorators.unload_allowed("pt.hive.colony.plugins.data_converter.io_adapter.pickle", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.base.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.data_converter.io_adapter.pickle", "1.0.0")
