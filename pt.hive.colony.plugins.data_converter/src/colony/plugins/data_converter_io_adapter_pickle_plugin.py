...
class DataConverterIoAdapterPicklePlugin(colony.plugins.plugin_system.Plugin):
    """
    Provides a means to load and save intermediate structures
    to and from pickle binary format.
    """

    id = "pt.hive.colony.plugins.data_converter.io_adapter.pickle"
    name = "Data Converter Input Output Adapter Pickle plugin"
    short_name = "Data Converter Input Output Adapter Pickle"
    description = "Provides a means to load and save intermediate structures to and from pickle binary format"
    version = "1.0.0"
    author = "Hive Solutions Lda. <development@hive.pt>"
    loading_type = colony.plugins.plugin_system.EAGER_LOADING_TYPE
    platforms = [colony.plugins.plugin_system.CPYTHON_ENVIRONMENT]
    capabilities = ["data_converter_io_adapter.pickle"]
    ...
    @colony.plugins.decorators.load_allowed("pt.hive.colony.plugins.data_converter.io_adapter.pickle", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.plugins.decorators.unload_allowed("pt.hive.colony.plugins.data_converter.io_adapter.pickle", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.data_converter.io_adapter.pickle", "1.0.0")
