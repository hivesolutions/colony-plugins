...
class DataConverterIntermediateStructureIoAdapterPickle(colony.plugins.plugin_system.Plugin):
    """
    ...
    name = "Data Converter Input Output Csv Test Plugin"
    short_name = "Data Converter Input Output Csv Test"
    description = "Data Converter Input Output Csv Test Plugin"
    version = "1.0.0"
