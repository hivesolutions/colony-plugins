...
import data_converter.adapter.output.configuration.output_configuration_parser
import model_domain
import sqlalchemy_io
...
class OutputAdapter:
    ...
    def load_configuration(self):
        ...
        self.data_converter_plugin.generate_event("output_configuration_changed", [self.output_configuration])
    ...
    def convert(self, task, args, connection, configuration):
        ...
        self.sqlalchemy_io = sqlalchemy_io.SqlAlchemyInputOutput()
        engine = self.sqlalchemy_io.get_engine("mysql", "hive", "hive", "hivetest")
