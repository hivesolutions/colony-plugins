...
class DataConverterOptionMissing(DataConverterException):
    """
    The data converter option missing class.
    """
...
class DataConverterPluginMissing(DataConverterException):
    """
    The data converter plugin missing option class.
    """
