...
class DataConverterIoAdapterCsvPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/data_converter_io_adapter_csv/io_adapter_csv/resources/baf.xml"
    }
    capabilities = [
        "data_converter_io_adapter.csv",
        "build_automation_item"
    ]
    main_modules = [
        "data_converter_io_adapter_csv.io_adapter_csv.data_converter_io_adapter_csv_exceptions",
