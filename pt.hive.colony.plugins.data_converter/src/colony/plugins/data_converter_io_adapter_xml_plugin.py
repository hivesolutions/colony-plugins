...
class DataConverterIoAdapterXmlPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    capabilities = ["data_converter_io_adapter.xml"]
    ...
    def load_plugin(self):
        ...
        global data_converter_io_adapter_xml
        import data_converter_io_adapter_xml.io_adapter_xml.io_adapter_xml_system
        self.io_adapter_xml = data_converter_io_adapter_xml.io_adapter_xml.io_adapter_xml_system.IoAdapterXml(self)
    ...
    @colony.plugins.decorators.load_allowed("pt.hive.colony.plugins.data_converter.io_adapter.xml", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.plugins.decorators.unload_allowed("pt.hive.colony.plugins.data_converter.io_adapter.xml", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.data_converter.io_adapter.xml", "1.0.0")
