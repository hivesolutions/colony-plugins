...
class MainServiceXmppHelperPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_xmpp_helper/xmpp_helper/resources/baf.xml"}
