...
class MainServiceXmppStarterPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_service_xmpp_starter/starter/resources/baf.xml"}
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.xmpp.starter", "1.0.0")
    ...
    @colony.plugins.decorators.plugin_inject("pt.hive.colony.plugins.main.service.xmpp")
