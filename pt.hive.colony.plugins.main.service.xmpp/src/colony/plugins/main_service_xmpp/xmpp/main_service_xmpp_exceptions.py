...
class MainServiceXmppException(colony.base.plugin_system_exceptions.ColonyException):
    """
...
class XmppDataRetrievalException(XmppRuntimeException):
    """
    The xmpp data retrieval exception.
    """
    ...
    def __str__(self):
        ...
        return "Xmpp data retrieval exception: %s" % self.message

class XmppDataSendingException(XmppRuntimeException):
    """
    The xmpp data sending exception.
    """
    ...
    def __str__(self):
        ...
        return "Xmpp data sending exception: %s" % self.message
