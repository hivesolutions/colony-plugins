...
class StartupConfigurationPlugin(colony.base.plugin_system.PluginManagerPlugin):
    ...
    id = "pt.hive.colony.plugins.configuration.startup"
    name = "Startup Configuration Plugin"
    short_name = "Startup Configuration"
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/configuration_startup/startup/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "configuration_startup.startup.startup_configuration_parser",
