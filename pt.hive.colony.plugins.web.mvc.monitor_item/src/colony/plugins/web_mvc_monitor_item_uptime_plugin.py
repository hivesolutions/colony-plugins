...
class WebMvcMonitorItemUptimePlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Web Mvc Monitor Item uptime plugin.
    """

    id = "pt.hive.colony.plugins.web.mvc.monitor_item.uptime"
    name = "Web Mvc Monitor Item Uptime Plugin"
    short_name = "Web Mvc Monitor Item Uptime"
    description = "The plugin that offers the web mvc monitor item uptime"
    version = "1.0.0"
    author = "Hive Solutions Lda. <development@hive.pt>"
    loading_type = colony.base.plugin_system.EAGER_LOADING_TYPE
    platforms = [colony.base.plugin_system.CPYTHON_ENVIRONMENT]
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/web_mvc_monitor_item/uptime/resources/baf.xml"}
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["web_mvc_monitor_item.uptime.web_mvc_monitor_item_uptime_system"]

    web_mvc_monitor_uptime_system = None
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.web.mvc.monitor_item.uptime", "1.0.0")
