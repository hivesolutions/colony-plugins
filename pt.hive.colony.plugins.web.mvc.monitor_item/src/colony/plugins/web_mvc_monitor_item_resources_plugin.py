...
class WebMvcMonitorItemResourcesPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.web.mvc.monitor_item.resources", "1.0.0")
