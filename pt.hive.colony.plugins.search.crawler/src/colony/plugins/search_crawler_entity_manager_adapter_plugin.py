...
class SearchCrawlerEntityManagerAdapterPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/search_crawler/entity_manager_adapter/resources/baf.xml"}
    capabilities = ["search_crawler_adapter.entity_manager", "build_automation_item"]
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["search_crawler.entity_manager_adapter.search_crawler_entity_manager_adapter_exceptions",
    ...
    @colony.plugins.decorators.load_allowed("pt.hive.colony.plugins.search.crawler.entity_manager_adapter", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.plugins.decorators.unload_allowed("pt.hive.colony.plugins.search.crawler.entity_manager_adapter", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.search.crawler.entity_manager_adapter", "1.0.0")
