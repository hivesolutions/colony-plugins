...
class MainServicePolicyPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["main_service_policy.policy.main_service_policy_system", "main_service_policy.policy.main_service_policy_exceptions"]
    ...
    @colony.plugins.decorators.load_allowed("pt.hive.colony.plugins.main.service.policy", "1.0.0")
    def load_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.load_allowed(self, plugin, capability)

    @colony.plugins.decorators.unload_allowed("pt.hive.colony.plugins.main.service.policy", "1.0.0")
    def unload_allowed(self, plugin, capability):
        colony.plugins.plugin_system.Plugin.unload_allowed(self, plugin, capability)

    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.policy", "1.0.0")
    ...
    @colony.plugins.decorators.load_allowed_capability("policy_service_handler")
