...
class MainServicePolicyException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
    The main service policy exception class.
    """
...
class PolicyRuntimeException(MainServicePolicyException):
    ...
    def __str__(self):
        ...
        return "Policy runtime exception: %s" % self.message

class PolicyInvalidDataException(PolicyRuntimeException):
    """
    The policy invalid data exception class.
    """
