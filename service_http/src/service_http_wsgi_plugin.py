...
class ServiceHTTPWSGIPlugin(colony.Plugin):
    ...
    id = "pt.hive.colony.plugins.service.http.wsgi"
    name = "HTTP Service WSGI"
    description = "The plugin that offers the HTTP service WSGI"
    version = "1.0.0"
    ...
    main_modules = ["service_http_wsgi"]
