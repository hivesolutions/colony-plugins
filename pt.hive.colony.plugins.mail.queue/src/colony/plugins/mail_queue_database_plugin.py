...
class MailQueueDatabasePlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Mail Queue Database plugin.
    """

    id = "pt.hive.colony.plugins.mail.queue.database"
    name = "Mail Queue Database Plugin"
    short_name = "Mail Queue Database"
    description = "Mail Queue Database Plugin"
    version = "1.0.0"
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["mail_queue_database.database.mail_queue_database_system"]
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.mail.queue.database", "1.0.0")
    def dependency_injected(self, plugin):
        colony.plugins.plugin_system.Plugin.dependency_injected(self, plugin)

    def create_client(self, parameters):
        return self.mail_queue_database.create_client(parameters)
