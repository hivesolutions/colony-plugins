...
class MailQueueDatabasePlugin(colony.base.plugin_system.Plugin):
    """
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.mail.queue.database", "1.0.0")
