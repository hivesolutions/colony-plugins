...
class MainClientDnsPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/main_client_dns/dns/resources/baf.xml"
    }
    capabilities = [
        "client.dns",
    ...
    main_modules = [
        "main_client_dns.dns.main_client_dns_exceptions",
