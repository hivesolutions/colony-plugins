...
class MainSoapClient:
    """
    The main soap client class.
    """

    main_soap_client_plugin = None
    """ The main soap client plugin """
    ...
    def __init__(self, main_soap_client_plugin):
        ...
        self.main_soap_client_plugin = main_soap_client_plugin
