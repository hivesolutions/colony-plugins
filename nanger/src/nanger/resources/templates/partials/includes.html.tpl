...
<link rel="stylesheet" href="${out_none value=base_path /}resources/libs/layout/css/layout.css" type="text/css" />
...
<script type="text/javascript" src="${out_none value=base_path /}resources/libs/uxf/js/ux-min.js"></script>
<script type="text/javascript" src="${out_none value=base_path /}resources/libs/layout/js/layout.js"></script>
