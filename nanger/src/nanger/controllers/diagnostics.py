...
METHOD_COLOR = dict(GET="green", POST="blue")
...
class DiagnosticsController(BaseController):
    ...
    def requests_list(self, request):
        ...
        for _request in requests_l:
            ...
            if not _filter in path:
                continue
            if until and initial > until:
                continue
            if not "time" in _request:
                continue
    ...
    def _build_request(self, request):
        ...
        if time >= 1000:
            ...
            time_color = "text-orange"
        else:
            time_color = "text-normal"
        ...
        if code // 100 in (4, 5):
            ...
            code_color = "text-blue"
        else:
            code_color = "text-normal"
