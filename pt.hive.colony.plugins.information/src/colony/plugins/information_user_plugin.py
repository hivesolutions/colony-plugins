...
class InformationUserPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the User Information plugin.
    """

    id = "pt.hive.colony.plugins.information.user"
    name = "User Information Plugin"
    short_name = "User Information"
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/information/user/resources/baf.xml"}
    capabilities = ["information.user", "build_automation_item"]
    ...
    @colony.base.decorators.set_configuration_property("pt.hive.colony.plugins.information.user", "1.0.0")
    def set_configuration_property(self, property_name, property):
        colony.base.plugin_system.Plugin.set_configuration_property(self, property_name, property)

    @colony.base.decorators.unset_configuration_property("pt.hive.colony.plugins.information.user", "1.0.0")
    ...
    def configuration_set_configuration_property(self, property_name, property):
        self.information_user.set_configuration_property(property)
    ...
    def configuration_unset_configuration_property(self, property_name):
        self.information_user.unset_configuration_property()
