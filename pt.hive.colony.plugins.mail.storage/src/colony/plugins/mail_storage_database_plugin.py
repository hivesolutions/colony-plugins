...
class MailStorageDatabasePlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Mail Storage Database plugin.
    """

    id = "pt.hive.colony.plugins.mail.storage.database"
    name = "Mail Storage Database Plugin"
    short_name = "Mail Storage Database"
    description = "Mail Storage Database Plugin"
    version = "1.0.0"
    author = "Hive Solutions Lda. <development@hive.pt>"
    loading_type = colony.base.plugin_system.EAGER_LOADING_TYPE
    platforms = [colony.base.plugin_system.CPYTHON_ENVIRONMENT]
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/mail_storage_database/database/resources/baf.xml"}
    capabilities = ["mail_storage", "build_automation_item"]
    capabilities_allowed = []
    dependencies = [colony.base.plugin_system.PluginDependency(
                    "pt.hive.colony.plugins.data.entity_manager_helper", "1.0.0")]
    events_handled = []
    events_registrable = []
    main_modules = ["mail_storage_database.database.mail_storage_database_entities",
                    "mail_storage_database.database.mail_storage_database_exceptions",
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.mail.storage.database", "1.0.0")
