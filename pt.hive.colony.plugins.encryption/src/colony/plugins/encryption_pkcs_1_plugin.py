...
class EncryptionPkcs1Plugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/encryption/pkcs_1/resources/baf.xml"}
    capabilities = ["encryption.pkcs_1", "build_automation_item"]
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.encryption.pkcs_1", "1.0.0")
