...
class MainClientApplePushPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/main_client_apple_push/apple_push/resources/baf.xml"
    }
    capabilities = [
        "client.apple_push",
    ...
    main_modules = [
        "main_client_apple_push.apple_push.main_client_apple_push_structures",
        "main_client_apple_push.apple_push.main_client_apple_push_system"
    ]

    main_client_apple_push = None
    """ The main client apple push """
