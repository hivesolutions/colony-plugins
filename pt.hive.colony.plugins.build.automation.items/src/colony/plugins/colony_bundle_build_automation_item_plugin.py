...
class ColonyBundleBuildAutomationItemPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/build_automation_items/colony_bundle/resources/baf.xml"
    }
    capabilities = [
        "build_automation_item"
    ]
    main_modules = [
        "build_automation_items.colony_bundle.colony_bundle_build_automation_item_system"
    ]

    colony_bundle_build_automation_item = None
    """ The colony bundle build automation item """
