...
class ColonyBaseBuildAutomationItemPlugin(colony.base.plugin_system.Plugin):
    ...
    description = "The build automation item for the base of the colony framework"
    version = "1.0.0"
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/build_automation_items/colony_base/resources/baf.xml"
    }
    capabilities = [
        "build_automation_item"
    ]
    main_modules = [
        "build_automation_items.colony_base.colony_base_build_automation_item_system"
    ]

    colony_base_build_automation_item = None
    """ The colony base build automation item """
