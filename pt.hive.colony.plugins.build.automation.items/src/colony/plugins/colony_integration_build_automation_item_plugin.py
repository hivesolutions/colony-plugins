...
class ColonyIntegrationBuildAutomationItemPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/build_automation_items/colony_integration/resources/baf.xml"}
    capabilities = ["build_automation_item"]
    capabilities_allowed = []
    dependencies = []
    events_handled = []
    events_registrable = []
    main_modules = ["build_automation_items.colony_integration.colony_integration_build_automation_item_system"]
