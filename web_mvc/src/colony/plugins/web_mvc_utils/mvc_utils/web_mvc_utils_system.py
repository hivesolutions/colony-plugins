...
class WebMvcUtils:
    ...
    models_modules_map = {}
    """ The map containing the various models modules associated with the entity manager ids """

    package_path_models_map = {}
    """ The map associating a package path with the internal models """

    package_path_controllers_map = {}
    """ The map associating a package path with the internal controllers """
    ...
    def import_module_mvc_utils(self, module_name, package_name, directory_path = None, system_instance = None):
        ...
        # sets the web mvc utils in the globals map, this is useful
        # allow later reference of the web mvc utils in the created
    ...
    def create_controller(self, base_controller, base_arguments_list, base_arguments_map, start_structures = False, default_parameters = {}):
        ...
        controller.extend_default_parameters(default_parameters)
        ...
        controller.set_relative_resources_path(resources_path)
    ...
    def create_file_manager(self, engine_name, connection_parameters = {}):
        ...
        file_manager_plugin = self.web_mvc_utils_plugin.file_manager_plugin
