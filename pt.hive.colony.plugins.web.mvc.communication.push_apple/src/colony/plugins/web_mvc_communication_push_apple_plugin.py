...
class WebMvcCommunicationPushApplePlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Web Mvc Communication Push Apple plugin.
    """

    id = "pt.hive.colony.plugins.web.mvc.communication.push_apple"
    name = "Web Mvc Communication Push Apple Plugin"
    short_name = "Web Mvc Communication Push Apple"
    description = "The plugin that offers the web mvc communication push apple base infrastructure"
    version = "1.0.0"
    ...
    def configuration_set_configuration_property(self, property_name, property):
        self.web_mvc_communication_push_apple.set_configuration_property(property)
    ...
    def configuration_unset_configuration_property(self, property_name):
        self.web_mvc_communication_push_apple.unset_configuration_property()
