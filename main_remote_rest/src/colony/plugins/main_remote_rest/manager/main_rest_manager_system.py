...
class RestRequest:
    ...
    def get_plugin_manager(self):
        ...
        # retrieves the main rest manager plugin and then
        # uses it to retrieve the plugin manager
        main_rest_manager_plugin = self.main_rest_manager.main_rest_manager_plugin
        plugin_manager = main_rest_manager_plugin.manager
    ...
    def _update_session_cookie(self):
        ...
        if not self.session: raise main_rest_manager_exceptions.InvalidSession("no session started or session timed out")
