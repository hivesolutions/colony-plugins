...
class RevisionControlBuildAutomationExtensionPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/build_automation_extensions/revision_control/resources/baf.xml"}
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["build_automation_extensions.revision_control.revision_control_build_automation_extension_system"]
    ...
    def run_automation(self, plugin, stage, parameters, build_automation_structure, logger):
        self.revision_control_build_automation_extension.run_automation(plugin, stage, parameters, build_automation_structure, logger)
