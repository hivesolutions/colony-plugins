...
class ReportGeneratorBuildAutomationExtensionPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Report Generator Build Automation Extension plugin
    """

    id = "pt.hive.colony.plugins.build.automation.extensions.report_generator"
    name = "Report Generator Build Automation Extension Plugin"
    short_name = "Report Generator Build Automation Extension"
    description = "A plugin to manage the report generator build automation tasks"
    version = "1.0.0"
    ...
    def run_automation(self, plugin, stage, parameters, build_automation_structure, logger):
        return self.report_generator_build_automation_extension.run_automation(plugin, stage, parameters, build_automation_structure, logger)
