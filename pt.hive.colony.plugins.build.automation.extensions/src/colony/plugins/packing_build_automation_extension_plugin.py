...
class PackingBuildAutomationExtensionPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/build_automation_extensions/packing/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "build_automation_extensions.packing.packing_build_automation_extension_exceptions",
        "build_automation_extensions.packing.packing_build_automation_extension_system"
    ]

    packing_build_automation_extension = None
    """ The packing build automation extension """
    ...
    def run_automation(self, plugin, stage, parameters, build_automation_structure, logger):
        return self.packing_build_automation_extension.run_automation(plugin, stage, parameters, build_automation_structure, logger)
