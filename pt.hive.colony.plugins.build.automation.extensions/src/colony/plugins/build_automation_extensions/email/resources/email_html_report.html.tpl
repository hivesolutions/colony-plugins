            ...
            <table width="600" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="400" align="left" style="line-height:1.8em;margin-bottom:20px;margin-top:0;">
                        ...
                        <p>
                            <font face="Arial" size="2" color="#333333">
                                <font face="Rockwell, Arial" size="3" color="#214c8f"><b><a href="#">r${out_none value=change.number xml_escape=True /}</a> - Tobias (${out_none value=change.author xml_escape=True /})</b></font><br />
