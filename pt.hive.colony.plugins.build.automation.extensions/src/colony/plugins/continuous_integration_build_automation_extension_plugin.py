...
class ContinuousIntegrationBuildAutomationExtensionPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Continuous Integration Build Automation Extension plugin
    """

    id = "pt.hive.colony.plugins.build.automation.extensions.continuous_integration"
    name = "Continuous Integration Build Automation Extension Plugin"
    short_name = "Continuous Integration Build Automation Extension"
    description = "A plugin to manage the continuous integration build automation tasks"
    version = "1.0.0"
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/build_automation_extensions/continuous_integration/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "build_automation_extensions.continuous_integration.continuous_integration_build_automation_extension_system"
    ]

    continuous_integration_build_automation_extension = None
    """ The continous integration build automation extension """
