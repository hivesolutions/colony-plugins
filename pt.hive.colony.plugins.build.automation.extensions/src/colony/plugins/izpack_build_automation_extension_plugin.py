...
class IzpackBuildAutomationExtensionPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/build_automation_extensions/izpack/resources/baf.xml"
    }
    capabilities = [
    ...
    dependencies = [
        ...
        colony.base.plugin_system.PluginDependency("pt.hive.colony.plugins.misc.execution_environment", "1.0.0"),
        colony.base.plugin_system.PluginDependency("pt.hive.colony.plugins.misc.command_execution", "1.0.0")
    ]
    main_modules = [
        "build_automation_extensions.izpack.izpack_build_automation_extension_exceptions",
        "build_automation_extensions.izpack.izpack_build_automation_extension_system"
    ]

    izpack_build_automation_extension = None
    """ The izpack build automation extension """
