...
class InstallationBuildAutomationExtensionPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.build.automation.extensions.installation", "1.0.0")
    ...
    @colony.plugins.decorators.plugin_inject("pt.hive.colony.plugins.installation.manager")
