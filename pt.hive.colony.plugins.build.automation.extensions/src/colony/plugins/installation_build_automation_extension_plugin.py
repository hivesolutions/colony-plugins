...
class InstallationBuildAutomationExtensionPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Installation Build Automation Extension plugin
    """

    id = "pt.hive.colony.plugins.build.automation.extensions.installation"
    name = "Installation Build Automation Extension Plugin"
    short_name = "Installation Build Automation Extension"
    description = "A plugin to manage the installation build automation tasks"
    version = "1.0.0"
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.build.automation.extensions.installation", "1.0.0")
    def dependency_injected(self, plugin):
        colony.base.plugin_system.Plugin.dependency_injected(self, plugin)

    def run_automation(self, plugin, stage, parameters, build_automation_structure, logger):
        return self.installation_build_automation_extension.run_automation(plugin, stage, parameters, build_automation_structure, logger)

    def get_installation_manager_plugin(self):
        return self.installation_manager_plugin

    @colony.base.decorators.plugin_inject("pt.hive.colony.plugins.installation.manager")
    def set_installation_manager_plugin(self, installation_manager_plugin):
