...
class CommandExecutionBuildAutomationExtensionPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Command Execution Build Automation Extension plugin
    """

    id = "pt.hive.colony.plugins.build.automation.extensions.command_execution"
    name = "Command Execution Build Automation Extension Plugin"
    short_name = "Command Execution Build Automation Extension"
    description = "A plugin to manage the command execution build automation tasks"
    version = "1.0.0"
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.build.automation.extensions.command_execution", "1.0.0")
    def dependency_injected(self, plugin):
        colony.base.plugin_system.Plugin.dependency_injected(self, plugin)

    def run_automation(self, plugin, stage, parameters, build_automation_structure, logger):
        return self.command_execution_build_automation_extension.run_automation(plugin, stage, parameters, build_automation_structure, logger)
