...
class RepositoryGeneratorBuildAutomationExtensionPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Repository Generator Build Automation Extension plugin
    """

    id = "pt.hive.colony.plugins.build.automation.extensions.repository.generator"
    name = "Repository Generator Build Automation Extension Plugin"
    short_name = "Repository Generator Build Automation Extension"
    description = "A plugin to manage the repository generator build automation tasks"
    version = "1.0.0"
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.build.automation.extensions.repository.generator", "1.0.0")
    def dependency_injected(self, plugin):
        colony.base.plugin_system.Plugin.dependency_injected(self, plugin)

    def run_automation(self, plugin, stage, parameters, build_automation_structure, logger):
        return self.repository_generator_build_automation_extension.run_automation(plugin, stage, parameters, build_automation_structure, logger)

    def get_repository_generator_manager_plugin(self):
        return self.repository_generator_manager_plugin
