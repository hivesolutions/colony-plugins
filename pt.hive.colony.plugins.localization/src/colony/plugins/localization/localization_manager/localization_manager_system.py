...
class LocalizationManager:
    """
    The localization manager class.
    """

    def __init__(self, localization_manager_plugin):
        """
        Constructor of the class.

        @type localization_manager_plugin: LocalizationManagerPlugin
        @param localization_manager_plugin: The localization manager plugin.
        """

        self.localization_manager_plugin = localization_manager_plugin
