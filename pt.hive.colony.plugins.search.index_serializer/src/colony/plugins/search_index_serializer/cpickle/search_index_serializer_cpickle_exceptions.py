...
class SearchIndexSerializerCpickleException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
...
class MissingProperty(SearchIndexSerializerCpickleException):
    ...
    def __init__(self, message):
        ...
        SearchIndexSerializerCpickleException.__init__(self)
