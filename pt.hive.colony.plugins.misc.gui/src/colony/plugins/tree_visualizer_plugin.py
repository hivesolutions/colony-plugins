...
class TreeVisualizerPlugin(colony.plugins.plugin_system.Plugin):
    """
    The main class for the Tree Visualizer plugin
    """

    id = "pt.hive.colony.plugins.misc.gui.tree_visualizer"
    name = "Tree Visualizer Plugin"
