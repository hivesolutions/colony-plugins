...
class ConsoleInterfacePlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["console_interface.console_interface_system", "console_interface.console_window"]
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.misc.gui.console_interface", "1.0.0")
