...
class WorkPoolManagerPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    events_handled = []
    events_registrable = []
    main_modules = ["main_work.work_pool_manager.work_pool_manager_algorithms", "main_work.work_pool_manager.work_pool_manager_system"]
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.work.work_pool_manager", "1.0.0")
    def dependency_injected(self, plugin):
        colony.plugins.plugin_system.Plugin.dependency_injected(self, plugin)

    def create_new_work_pool(self, name, description, work_processing_task_class, number_threads, scheduling_algorithm, maximum_number_threads, maximum_number_works_thread):
        return self.work_pool_manager.create_new_work_pool(name, description, work_processing_task_class, number_threads, scheduling_algorithm, maximum_number_threads, maximum_number_works_thread)
