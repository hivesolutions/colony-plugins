...
class ServiceBarganiaPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Bargania Service plugin.
    """

    id = "pt.hive.colony.plugins.service.bargania"
    name = "Bargania Service Plugin"
    short_name = "Bargania Service Main"
    description = "The plugin that offers the bargania service"
    version = "1.0.0"
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/service_bargania/bargania/resources/baf.xml"
    }
    capabilities = [
        "service.bargania",
    ...
    main_modules = [
        "service_bargania.bargania.service_bargania_exceptions",
        "service_bargania.bargania.service_bargania_system"
    ]

    service_bargania = None
    """ The service bargania """
    ...
    def load_plugin(self):
        ...
        import service_bargania.bargania.service_bargania_system
        self.service_bargania = service_bargania.bargania.service_bargania_system.ServiceBargania(self)
    ...
    def create_remote_client(self, service_attributes):
        ...
        return self.service_bargania.create_remote_client(service_attributes)
