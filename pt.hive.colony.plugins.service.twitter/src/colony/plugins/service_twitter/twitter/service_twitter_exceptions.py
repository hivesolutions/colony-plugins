...
class ServiceTwitterException(colony.base.plugin_system_exceptions.ColonyException):
    """
...
class InvalidAuthentication(ServiceTwitterException):
    ...
    def __init__(self, message):
        ...
        ServiceTwitterException.__init__(self)
...
class StatusUpdateProblem(ServiceTwitterException):
    """
    ...
    def __str__(self):
        ...
        return "Status update problem: %s" % self.message
