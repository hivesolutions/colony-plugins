...
class WebMvcManagerPageItemCodeExecutionPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Web Mvc Manager Page Item Code Execution plugin.
    """

    id = "pt.hive.colony.plugins.web.mvc.manager.page_item.code_execution"
    name = "Web Mvc Manager Page Item Code Execution Plugin"
    short_name = "Web Mvc Manager Page Item Code Execution"
    description = "The plugin that offers the web mvc manager page item code execution"
    version = "1.0.0"
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/web_mvc_manager_page_item/code_execution/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        "web_mvc_manager_page_item.code_execution.web_mvc_manager_page_item_code_execution_controllers",
    ...
    def end_load_plugin(self):
        ...
        self.web_mvc_manager_page_item_code_execution.load_components()
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.web.mvc.manager.page_item.code_execution", "1.0.0")
    ...
    def get_resource_patterns(self):
        ...
        return self.web_mvc_manager_page_item_code_execution.get_resource_patterns()
    ...
    def get_page_item_bundle(self, parameters):
        ...
        return self.web_mvc_manager_page_item_code_execution.get_page_item_bundle(parameters)
