...
class WebMvcManagerPageItemRepositoryPlugin(colony.base.plugin_system.Plugin):
    ...
    id = "pt.hive.colony.plugins.web.mvc.manager.page_item.repository"
    name = "Web Mvc Manager Page Item Repository Plugin"
    short_name = "Web Mvc Manager Page Item Repository"
    ...
    def get_patterns(self):
        ...
        return self.web_mvc_manager_page_item_repository.get_patterns()
    ...
    def get_communication_patterns(self):
        ...
        return self.web_mvc_manager_page_item_repository.get_communication_patterns()
