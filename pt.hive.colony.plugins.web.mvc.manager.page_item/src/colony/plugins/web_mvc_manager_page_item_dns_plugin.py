...
class WebMvcManagerPageItemDnsPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/web_mvc_manager_page_item/dns/resources/baf.xml"}
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.web.mvc.manager.page_item.dns", "1.0.0")
