...
class SearchScorerFunction:
    """
    The search scorer function class.
    """
    ...
    def compute(self, search_results, properties):
        """
        The main entry point for the function object. Method that implements the function computation.
        
        @type search_results: List
        @param search_results: The list of search results to score using the function
        @type properties: Dictionary
        @param properties: The properties to configure the scoring function behavior.
        @rtype: List
        @return: The list of computed scores for the given search results.    
        """
