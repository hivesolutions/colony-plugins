...
class MainPackingManagerPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/main_packing/manager/resources/baf.xml"
    }
    capabilities = [
        "packing_manager",
    ...
    main_modules = [
        "main_packing.manager.console_main_packing_manager",
    ...
    """ The main packing manager """

    console_main_packing_manager = None
    """ The console main packing manager """

    packing_service_plugins = []
    """ The packing service plugins """
    ...
    def get_packing_file_contents(self, file_path, properties, service_name):
        ...
        return self.main_packing_manager.get_packing_file_contents(file_path, properties, service_name)
