...
class MainPackingColonyServiceException(colony.base.plugin_system_exceptions.ColonyException):
    """
    The main packing colony service exception class.
    """

    message = None
    """ The exception's message """

class PluginProcessingException(MainPackingColonyServiceException):
    """
    The plugin processing exception class.
    """
