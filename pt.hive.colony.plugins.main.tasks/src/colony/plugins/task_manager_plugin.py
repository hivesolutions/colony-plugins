...
class TaskManagerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/main_tasks/task_manager/resources/baf.xml"
    }
    capabilities = [
        "task_manager",
        "task_information",
    ...
    main_modules = [
        "main_tasks.task_manager.task_manager_system"
    ]
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.main.tasks.task_manager", "1.0.0")
