...
class SearchProviderTextException(colony.plugins.plugin_system_exceptions.ColonyException):
    """
...
class MissingProperty(SearchProviderTextException):
    ...
    def __init__(self, message):
        ...
        SearchProviderTextException.__init__(self)
...
class TextFileNotFound(SearchProviderTextException):
    """
