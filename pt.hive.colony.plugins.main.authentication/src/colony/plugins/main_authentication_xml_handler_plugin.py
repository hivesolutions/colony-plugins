...
class MainAuthenticationXmlHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/main_authentication_xml_handler/xml_handler/resources/baf.xml"}
