...
class MainAuthenticationLdapHandlerPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    dependencies = [
        colony.base.plugin_system.PluginDependency("pt.hive.colony.plugins.main.client.ldap", "1.0.0")
    ]
    main_modules = [
