...
class WebMvcManagerBasePlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Web Mvc Manager Base plugin.
    """

    id = "pt.hive.colony.plugins.web.mvc.manager.base"
    name = "Web Mvc Manager Base Plugin"
    short_name = "Web Mvc Manager Base"
    description = "The plugin that offers the web mvc manager base"
    version = "1.0.0"
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/web_mvc_manager/base/resources/baf.xml"
    }
    capabilities = [
        "web.mvc_service",
    ...
    main_modules = [
        ...
        "web_mvc_manager.base.web_mvc_manager_base_exceptions",
        "web_mvc_manager.base.web_mvc_manager_base_system"
    ]
    ...
    def load_plugin(self):
        ...
        import web_mvc_manager.base.web_mvc_manager_base_system
        self.web_mvc_manager_base = web_mvc_manager.base.web_mvc_manager_base_system.WebMvcManagerBase(self)

    def end_load_plugin(self):
        colony.base.plugin_system.Plugin.end_load_plugin(self)
        self.web_mvc_manager_base.load_components()
    ...
    def get_patterns(self):
        ...
        return self.web_mvc_manager_base.get_patterns()
    ...
    def get_communication_patterns(self):
        ...
        return self.web_mvc_manager_base.get_communication_patterns()
    ...
    def get_resource_patterns(self):
        ...
        return self.web_mvc_manager_base.get_resource_patterns()
    ...
    def get_page_item_bundle(self, parameters):
        ...
        return self.web_mvc_manager_base.get_page_item_bundle(parameters)
