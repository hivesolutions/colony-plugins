...
class WebMvcManagerDnsPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Web Mvc Manager Dns plugin.
    """

    id = "pt.hive.colony.plugins.web.mvc.manager.dns"
    name = "Web Mvc Manager Dns Plugin"
    short_name = "Web Mvc Manager Dns"
    description = "The plugin that offers the web mvc manager dns"
    version = "1.0.0"
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/web_mvc_manager/dns/resources/baf.xml"
    }
    capabilities = [
    ...
    main_modules = [
        ...
        "web_mvc_manager.dns.web_mvc_manager_dns_exceptions",
        "web_mvc_manager.dns.web_mvc_manager_dns_system"
    ]
    ...
    def load_plugin(self):
        ...
        import web_mvc_manager.dns.web_mvc_manager_dns_system
        self.web_mvc_manager_dns = web_mvc_manager.dns.web_mvc_manager_dns_system.WebMvcManagerDns(self)

    def end_load_plugin(self):
        colony.base.plugin_system.Plugin.end_load_plugin(self)
        self.web_mvc_manager_dns.load_components()
    ...
    def get_page_item_bundle(self, parameters):
        ...
        return self.web_mvc_manager_dns.get_page_item_bundle(parameters)
