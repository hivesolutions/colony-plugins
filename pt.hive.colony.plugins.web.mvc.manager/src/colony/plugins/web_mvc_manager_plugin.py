...
class WebMvcManagerPlugin(colony.plugins.plugin_system.Plugin):
    ...
    main_modules = ["web_mvc_manager.manager.web_mvc_manager_controllers", "web_mvc_manager.manager.web_mvc_manager_exceptions",
                    "web_mvc_manager.manager.web_mvc_manager_helpers", "web_mvc_manager.manager.web_mvc_manager_system"]
