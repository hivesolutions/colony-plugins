...
class WebMvcManagerCodeExecution:
    """
    The web mvc manager code execution class.
    """

    web_mvc_manager_code_execution_plugin = None
    """ The web mvc manager code execution plugin """

    def __init__(self, web_mvc_manager_code_execution_plugin):
        """
    ...
    def load_components(self):
        ...
        web_mvc_utils_plugin = self.web_mvc_manager_code_execution_plugin.web_mvc_utils_plugin

        # creates the controllers for the web mvc manager code execution controller modules
        web_mvc_utils_plugin.create_controllers("web_mvc_manager.code_execution.web_mvc_manager_code_execution_controllers", self, self.web_mvc_manager_code_execution_plugin, "web_mvc_manager_code_execution")
