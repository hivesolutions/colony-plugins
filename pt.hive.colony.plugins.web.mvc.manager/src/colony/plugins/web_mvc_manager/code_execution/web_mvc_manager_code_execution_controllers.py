...
WEB_MVC_MANAGER_CODE_EXECUTION_RESOURCES_PATH = "web_mvc_manager/code_execution/resources"
""" The web mvc manager code_execution resources path """
...
class MainController:
    ...
    web_mvc_manager_code_execution_plugin = None
    """ The web mvc manager code execution plugin """

    web_mvc_manager_code_execution = None
    """ The web mvc manager code execution """

    def __init__(self, web_mvc_manager_code_execution_plugin, web_mvc_manager_code_execution):
        """
        Constructor of the class.

        @type web_mvc_manager_code_execution_plugin: WebMvcManagerCodeExecutionPlugin
        @param web_mvc_manager_code_execution_plugin: The web mvc manager code execution plugin.
        @type web_mvc_manager_code_execution: WebMvcManagerCodeExecution
        @param web_mvc_manager_code_execution: The web mvc manager code execution.
        """

        self.web_mvc_manager_code_execution_plugin = web_mvc_manager_code_execution_plugin
        self.web_mvc_manager_code_execution = web_mvc_manager_code_execution
    ...
    def execute_command(self, rest_request, command):
        ...
        plugin_manager = self.web_mvc_manager_code_execution_plugin.manager
