...
class GuidPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/misc/guid/resources/baf.xml"}
    capabilities = ["guid", "build_automation_item"]
