...
class DependenciesCalculationPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/misc/dependencies_calculator/resources/baf.xml"}
    capabilities = ["dependencies_calculator", "build_automation_item"]
