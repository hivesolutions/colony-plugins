...
class StringNormalizationPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/misc/string_normalization/resources/baf.xml"}
    capabilities = ["string_normalization", "build_automation_item"]
    capabilities_allowed = []
    dependencies = []
    events_handled = []
    events_registrable = []
    main_modules = ["misc.string_normalization.string_normalization_system"]
