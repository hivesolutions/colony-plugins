...
class RandomPlugin(colony.base.plugin_system.Plugin):
    """
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/misc/random/resources/baf.xml"}
    capabilities = ["random", "build_automation_item"]
