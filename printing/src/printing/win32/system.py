...
class PrintingWin32(colony.base.system.System):
    ...
    def print_test(self, printing_options = {}):
        ...
        handler_device_context.DrawText(TEST_TEXT, (0, constants.INCH * -1, constants.INCH * 8, constants.INCH * -2), win32con.DT_CENTER)
    ...
    def get_default_printer_size(self, handler_device_context):
        return handler_device_context.GetDeviceCaps(constants.PHYSICAL_WIDTH), handler_device_context.GetDeviceCaps(constants.PHYSICAL_HEIGHT)

    def get_default_printer_margins(self, handler_device_context):
        return handler_device_context.GetDeviceCaps(constants.PHYSICAL_OFFSET_X), handler_device_context.GetDeviceCaps(constants.PHYSICAL_OFFSET_Y)
