...
class Visitor:
    ...
    @_visit(documentation_ast.AstNode)
    def visit_ast_node(self, node):
        print "AstNode: " + str(node)

    @_visit(documentation_ast.ProjectNode)
    def visit_project_node(self, node):
        print "ProjectNode: " + str(node)

    @_visit(documentation_ast.DocumentationElementNode)
    def visit_documentation_element_node(self, node):
        print "DocumentationElementNode: " + str(node)

    @_visit(documentation_ast.NamespaceNode)
    def visit_namespace_node(self, node):
        print "NamespaceNode: " + str(node)

    @_visit(documentation_ast.ClassNode)
    def visit_class_node(self, node):
        print "ClassNode: " + str(node)

    @_visit(documentation_ast.FunctionNode)
    def visit_function_node(self, node):
        print "FunctionNode: " + str(node)

    @_visit(documentation_ast.VariableNode)
    def visit_variable_node(self, node):
        print "VariableNode: " + str(node)

    @_visit(documentation_ast.ConstantNode)
    def visit_constant_node(self, node):
        print "ConstantNode: " + str(node)
