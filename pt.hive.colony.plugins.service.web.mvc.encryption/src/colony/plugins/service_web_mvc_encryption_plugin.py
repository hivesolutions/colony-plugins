...
class ServiceWebMvcEncryptionPlugin(colony.base.plugin_system.Plugin):
    ...
    attributes = {"build_automation_file_path" : "$base{plugin_directory}/service_web_mvc_encryption/web_mvc_encryption/resources/baf.xml"}
    capabilities = ["service.web.mvc.encryption", "build_automation_item"]
    capabilities_allowed = []
    dependencies = [colony.base.plugin_system.PluginDependency(
                    "pt.hive.colony.plugins.main.client.http", "1.0.0")]
    events_handled = []
    events_registrable = []
    main_modules = ["service_web_mvc_encryption.web_mvc_encryption.service_web_mvc_encryption_system"]
    ...
    @colony.base.decorators.inject_dependencies("pt.hive.colony.plugins.service.web.mvc.encryption", "1.0.0")
