...
class MainServiceIrcPlugin(colony.plugins.plugin_system.Plugin):
    """
    ...
    @colony.plugins.decorators.inject_dependencies("pt.hive.colony.plugins.main.service.irc", "1.0.0")
