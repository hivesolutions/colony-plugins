...
class WikiResourcesExtension(language_wiki.wiki_extension_system.WikiExtension):
    """
    The wiki resources extension class.
    """

    id = "pt.hive.colony.language.wiki.extensions.resources"
    """ The extension id """

    name = "Resources Generation Plugin"
    """ The name of the extension """

    short_name = "Resources Generation"
    """ The short name of the extension """

    description = "Extension for resources generation"
    ...
    def generate_html(self, tag_node, visitor):
        ...
        # writes the start div resources tag
        string_buffer.write("<div class=\"resources\">")

        # processes a new parse in the contents
        visitor.new_parse(contents, CONFIGURATION_MAP, string_buffer)

        # writes the end div resources tag
