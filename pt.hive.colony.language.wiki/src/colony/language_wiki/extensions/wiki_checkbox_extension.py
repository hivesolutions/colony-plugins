...
class WikiCheckboxExtension(language_wiki.wiki_extension_system.WikiExtension):
    """
    The wiki checkbox extension class.
    """

    id = "pt.hive.colony.language.wiki.extensions.checkbox"
    """ The extension id """

    name = "Checkbox Generation Plugin"
    """ The name of the extension """

    short_name = "Checkbox Generation"
    """ The short name of the extension """

    description = "Extension for checkbox generation"
    ...
    def generate_html(self, tag_node, visitor):
        ...
        # writes the start div checkbox tag
        string_buffer.write("<div class=\"checkbox\">")

        # processes a new parse in the contents
        visitor.new_parse(contents, CONFIGURATION_MAP, string_buffer)

        # writes the end div checkbox tag
