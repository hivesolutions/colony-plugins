...
class WikiHtmlExtension(language_wiki.wiki_extension_system.WikiExtension):
    """
    The wiki html extension class.
    """

    id = "pt.hive.colony.language.wiki.extensions.html"
    """ The extension id """

    name = "Html Generation Plugin"
    """ The name of the extension """

    short_name = "Html Generation"
    """ The short name of the extension """

    description = "Extension for html generation"
