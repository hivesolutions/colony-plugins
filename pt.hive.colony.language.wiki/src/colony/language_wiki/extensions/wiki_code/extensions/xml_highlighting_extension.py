...
class XmlHighlightingExtension(wiki_code.wiki_code_extension_system.WikiCodeExtension):
    """
    The xml highlighting extension class.
    """

    id = "pt.hive.colony.language.wiki.code.extensions.xml_highlighting"
    """ The extension id """

    name = "Xml Highlighting Code Plugin"
    """ The name of the extension """

    short_name = "Xml Highlighting Code"
    """ The short name of the extension """

    description = "Extension for xml code highlighting"
