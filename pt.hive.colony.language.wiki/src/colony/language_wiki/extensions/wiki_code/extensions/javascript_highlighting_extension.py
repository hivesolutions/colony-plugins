...
from javascript_highlighting.javascript_lexer import * #@UnusedWildImport
...
class JavascriptHighlightingExtension(wiki_code.wiki_code_extension_system.WikiCodeExtension):
    """
    The javascript highlighting extension class.
    """

    id = "pt.hive.colony.language.wiki.code.extensions.javascript_highlighting"
    """ The extension id """

    name = "Javascript Highlighting Code Plugin"
    """ The name of the extension """

    short_name = "Javascript Highlighting Code"
    """ The short name of the extension """

    description = "Extension for javascript code highlighting"
